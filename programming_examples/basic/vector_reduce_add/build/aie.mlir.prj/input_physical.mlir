module {
  aie.device(npu1_1col) {
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @reduce_add_vector(%in_cons_buff_1, %out_buff_1, %c1024_i32_0) : (memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in_cons_prod_lock, Release, 1)
      aie.use_lock(%out_cons_lock, Release, 1)
    ...
    ^bb3:  // pred: ^bb1
      ...
      func.call @reduce_add_vector(%in_cons_buff_0, %out_buff_0, %c1024_i32_1) : (memref<1024xi32>, memref<1xi32>, i32) -> ()
      aie.use_lock(%in_cons_prod_lock, Release, 1)
      aie.use_lock(%out_cons_lock, Release, 1)
      aie.end
