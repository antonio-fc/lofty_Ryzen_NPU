...
declare void @reduce_add_vector(ptr, ptr, i32)
...
4:                                                ; preds = %1
  ...
  call void @reduce_add_vector(ptr @in_cons_buff_0, ptr @out_buff_0, i32 1024)
  ...
  call void @reduce_add_vector(ptr @in_cons_buff_1, ptr @out_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 51, i32 1)
  %13 = add i64 %2, 2
  br label %1
