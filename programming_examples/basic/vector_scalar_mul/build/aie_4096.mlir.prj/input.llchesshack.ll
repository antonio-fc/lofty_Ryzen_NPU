...
@in_cons_buff_1 = external global [1024 x i16]
@in_cons_buff_0 = external global [1024 x i16]
@infactor_cons_buff_1 = external global [1 x i32]
@infactor_cons_buff_0 = external global [1 x i32]
@out_buff_1 = external global [1024 x i16]
@out_buff_0 = external global [1024 x i16]
@out_cons = external global [1024 x i16]
@out = external global [1024 x i16]
@infactor_cons = external global [1 x i32]
@infactor = external global [1 x i32]
@in_cons = external global [1024 x i16]
@in = external global [1024 x i16]
...
8:                                                ; preds = %5
  ...
  call void @vector_scalar_mul_int16_vector(ptr @in_cons_buff_0, ptr @out_buff_0, ptr @infactor_cons_buff_0, i32 1024)
  ...
  call void @vector_scalar_mul_int16_vector(ptr @in_cons_buff_1, ptr @out_buff_1, ptr @infactor_cons_buff_0, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  %19 = add i64 %6, 2
  br label %5
...
24:                                               ; preds = %21
  ...
  call void @vector_scalar_mul_int16_vector(ptr @in_cons_buff_0, ptr @out_buff_0, ptr @infactor_cons_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  call void @llvm.aie2.acquire(i32 52, i32 -1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  ...
  call void @vector_scalar_mul_int16_vector(ptr @in_cons_buff_1, ptr @out_buff_1, ptr @infactor_cons_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  %35 = add i64 %22, 2
  br label %21
