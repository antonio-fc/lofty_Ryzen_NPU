...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd2), /* addrA */ 0x2400,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd3), /* addrA */ 0x2404,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd5), /* addrA */ 0xC00,  /* len */ 2048));
...
// buffer out_buff_0 with unsupported type memref<1024xi16>;
// buffer out_buff_1 with unsupported type memref<1024xi16>;
const int infactor_cons_buff_0_offset = 9216;
...
const int infactor_cons_buff_1_offset = 9220;
...
// buffer in_cons_buff_0 with unsupported type memref<1024xi16>;
// buffer in_cons_buff_1 with unsupported type memref<1024xi16>;
