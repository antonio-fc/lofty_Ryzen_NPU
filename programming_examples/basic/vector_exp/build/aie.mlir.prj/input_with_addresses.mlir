module {
  aie.device(npu1_1col) {
    ...
    %outC_cons_prod_lock = aie.lock(%shim_noc_tile_0_0, 2) {init = 1 : i32, sym_name = "outC_cons_prod_lock"}
    %outC_cons_cons_lock = aie.lock(%shim_noc_tile_0_0, 3) {init = 0 : i32, sym_name = "outC_cons_cons_lock"}
    %outC_buff_0 = aie.buffer(%mem_tile_0_1) {address = 0 : i32, mem_bank = 0 : i32, sym_name = "outC_buff_0"} : memref<4096xbf16> 
    %outC_buff_1 = aie.buffer(%mem_tile_0_1) {address = 65536 : i32, mem_bank = 1 : i32, sym_name = "outC_buff_1"} : memref<4096xbf16> 
    %outC_prod_lock = aie.lock(%mem_tile_0_1, 2) {init = 8 : i32, sym_name = "outC_prod_lock"}
    %outC_cons_lock = aie.lock(%mem_tile_0_1, 3) {init = 0 : i32, sym_name = "outC_cons_lock"}
    ...
    %inA_cons_buff_0 = aie.buffer(%mem_tile_0_1) {address = 131072 : i32, mem_bank = 2 : i32, sym_name = "inA_cons_buff_0"} : memref<4096xbf16> 
    %inA_cons_buff_1 = aie.buffer(%mem_tile_0_1) {address = 196608 : i32, mem_bank = 3 : i32, sym_name = "inA_cons_buff_1"} : memref<4096xbf16> 
    %inA_cons_prod_lock = aie.lock(%mem_tile_0_1, 0) {init = 8 : i32, sym_name = "inA_cons_prod_lock"}
    ...
    aie.flow(%mem_tile_0_1, DMA : 4, %shim_noc_tile_0_0, DMA : 0)
