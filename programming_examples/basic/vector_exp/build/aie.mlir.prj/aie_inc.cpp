...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd0), /* addrA */ 0x1400,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd1), /* addrA */ 0x1C00,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd3), /* addrA */ 0xC00,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd0), /* addrA */ 0x1400,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd1), /* addrA */ 0x1C00,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd3), /* addrA */ 0xC00,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile04_bd0), /* addrA */ 0x1400,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile04_bd1), /* addrA */ 0x1C00,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile04_bd3), /* addrA */ 0xC00,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile05_bd0), /* addrA */ 0x1400,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile05_bd1), /* addrA */ 0x1C00,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile05_bd3), /* addrA */ 0xC00,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd0), /* addrA */ 0x84000,  /* len */ 8192));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd1), /* addrA */ 0x86000,  /* len */ 8192));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd2), /* addrA */ 0x84000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd3), /* addrA */ 0x86000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd24), /* addrA */ 0x84800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd25), /* addrA */ 0x86800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd4), /* addrA */ 0x85000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd5), /* addrA */ 0x87000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd26), /* addrA */ 0x85800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd27), /* addrA */ 0x87800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd29), /* addrA */ 0x82000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd7), /* addrA */ 0x82800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd31), /* addrA */ 0x83000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd9), /* addrA */ 0x83800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd11), /* addrA */ 0x82000,  /* len */ 8192));
