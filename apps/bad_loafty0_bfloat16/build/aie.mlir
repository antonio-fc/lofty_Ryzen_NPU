module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @in1(%tile_2_0, {%tile_1_4}, 2 : i32) : !aie.objectfifo<memref<1024xbf16>> 
    ...
    aie.objectfifo @u(%tile_1_1, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<1024xbf16>> 
    aie.objectfifo @v(%tile_1_1, {%tile_1_2}, 2 : i32) : !aie.objectfifo<memref<1024xbf16>> 
    aie.objectfifo @w(%tile_1_1, {%tile_2_2}, 2 : i32) : !aie.objectfifo<memref<1024xbf16>> 
    aie.objectfifo.link [@in2] -> [@u, @v, @w]([] [0, 1024, 2048])
    aie.objectfifo @l(%tile_2_1, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @m(%tile_2_1, {%tile_1_2}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @n(%tile_2_1, {%tile_2_2}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    ...
    aie.objectfifo @out(%tile_2_4, {%tile_3_0}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          ...
          func.call @vector_scalar_mul_aie_scalar(%3, %5, %1, %c1024_i32) : (memref<1024xbf16>, memref<1024xbf16>, memref<2xbf16>, i32) -> ()
    ...
    %core_2_3 = aie.core(%tile_2_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          ...
          %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<1024xbf16>> -> memref<1024xbf16>
          %c1024_i32 = arith.constant 1024 : i32
          func.call @vector_add_aie_scalar(%1, %3, %5, %c1024_i32) : (memref<1024xbf16>, memref<1024xbf16>, memref<1024xbf16>, i32) -> ()
    ...
    %core_1_4 = aie.core(%tile_1_4) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          ...
          %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<1024xbf16>> -> memref<1024xbf16>
          %c1024_i32 = arith.constant 1024 : i32
          func.call @vector_mult_aie_scalar(%1, %3, %5, %c1024_i32) : (memref<1024xbf16>, memref<1024xbf16>, memref<1024xbf16>, i32) -> ()
    ...
    %core_2_4 = aie.core(%tile_2_4) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<2xbf16>> -> memref<2xbf16>
        %2 = aie.objectfifo.acquire @of_meanF(Consume, 1) : !aie.objectfifosubview<memref<1024xbf16>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1024xbf16>> -> memref<1024xbf16>
        %c0_i32 = arith.constant 0 : i32
        %c0_i32_0 = arith.constant 0 : i32
        func.call @mean_w(%3, %1, %c0_i32, %c0_i32_0) : (memref<1024xbf16>, memref<2xbf16>, i32, i32) -> ()
        %c1024_i32 = arith.constant 1024 : i32
        %c1_i32 = arith.constant 1 : i32
        func.call @mean_w(%3, %1, %c1024_i32, %c1_i32) : (memref<1024xbf16>, memref<2xbf16>, i32, i32) -> ()
        aie.objectfifo.release @of_meanF(Consume, 1)
        %c2 = arith.constant 2 : index
        %c9 = arith.constant 9 : index
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c2 to %c9 step %c1_1 {
          %6 = aie.objectfifo.acquire @of_meanF(Consume, 1) : !aie.objectfifosubview<memref<1024xbf16>>
          ...
          func.call @mean_w(%7, %1, %c1024_i32_4, %c1_i32_5) : (memref<1024xbf16>, memref<2xbf16>, i32, i32) -> ()
          aie.objectfifo.release @of_meanF(Consume, 1)
        }
        %4 = aie.objectfifo.acquire @of_meanF(Consume, 1) : !aie.objectfifosubview<memref<1024xbf16>>
        %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<1024xbf16>> -> memref<1024xbf16>
        %c1024_i32_2 = arith.constant 1024 : i32
        %c1_i32_3 = arith.constant 1 : i32
        func.call @mean_w(%5, %1, %c1024_i32_2, %c1_i32_3) : (memref<1024xbf16>, memref<2xbf16>, i32, i32) -> ()
        %c9216_i32 = arith.constant 9216 : i32
        %c2_i32 = arith.constant 2 : i32
        func.call @mean_w(%5, %1, %c9216_i32, %c2_i32) : (memref<1024xbf16>, memref<2xbf16>, i32, i32) -> ()
        aie.objectfifo.release @of_meanF(Consume, 1)
