module {
  aie.device(npu1_4col) {
    ...
    aie.flow(%mem_tile_0_1, DMA : 2, %tile_0_5, DMA : 0)
    aie.flow(%mem_tile_3_1, DMA : 2, %tile_3_5, DMA : 0)
    aie.flow(%mem_tile_0_1, DMA : 3, %tile_0_4, DMA : 0)
    aie.flow(%mem_tile_3_1, DMA : 3, %tile_3_4, DMA : 0)
    aie.flow(%mem_tile_0_1, DMA : 4, %tile_0_3, DMA : 0)
    aie.flow(%mem_tile_3_1, DMA : 4, %tile_3_3, DMA : 0)
