module {
  aie.device(npu1_4col) {
    ...
    ^bb2:  // pred: ^bb1
      ...
      %2 = memref.load %in0_6_cons_buff_0[%c0] : memref<96xbf16>
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB21_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%2, %in0_6_cons_buff_0, %of_in_mainB21_cons_buff_0, %of_in_mainB21_cons_buff_1, %of_in_mainB21_cons_buff_2, %of_in_mainB21_cons_buff_3, %of_in_mainB21_cons_buff_4, %of_out_mainB21_buff_1, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB21_cons_lock, Release, 1)
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      %5 = arith.addi %3, %c2 : index
      cf.br ^bb3(%5 : index)
    ^bb5:  // pred: ^bb3
      ...
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      %6 = memref.load %in0_6_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB21_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb6(%c0 : index)
    ^bb6(%7: index):  // 2 preds: ^bb5, ^bb7
    ...
    ^bb7:  // pred: ^bb6
      ...
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB21_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%6, %in0_6_cons_buff_1, %of_in_mainB21_cons_buff_5, %of_in_mainB21_cons_buff_0, %of_in_mainB21_cons_buff_1, %of_in_mainB21_cons_buff_2, %of_in_mainB21_cons_buff_3, %of_out_mainB21_buff_1, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB21_cons_lock, Release, 1)
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      %9 = arith.addi %7, %c2 : index
      cf.br ^bb6(%9 : index)
    ^bb8:  // pred: ^bb6
      aie.use_lock(%of_in_mainB21_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      %10 = memref.load %in0_6_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB21_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb9(%c0 : index)
    ^bb9(%11: index):  // 2 preds: ^bb8, ^bb10
    ...
    ^bb10:  // pred: ^bb9
      ...
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB21_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%10, %in0_6_cons_buff_0, %of_in_mainB21_cons_buff_4, %of_in_mainB21_cons_buff_5, %of_in_mainB21_cons_buff_0, %of_in_mainB21_cons_buff_1, %of_in_mainB21_cons_buff_2, %of_out_mainB21_buff_1, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB21_cons_lock, Release, 1)
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      %13 = arith.addi %11, %c2 : index
      cf.br ^bb9(%13 : index)
    ^bb11:  // pred: ^bb9
      aie.use_lock(%of_in_mainB21_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      %14 = memref.load %in0_6_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB21_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb12(%c0 : index)
    ^bb12(%15: index):  // 2 preds: ^bb11, ^bb13
    ...
    ^bb13:  // pred: ^bb12
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB21_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%14, %in0_6_cons_buff_0, %of_in_mainB21_cons_buff_3, %of_in_mainB21_cons_buff_4, %of_in_mainB21_cons_buff_5, %of_in_mainB21_cons_buff_0, %of_in_mainB21_cons_buff_1, %of_out_mainB21_buff_0, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB21_cons_lock, Release, 1)
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB21_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%14, %in0_6_cons_buff_1, %of_in_mainB21_cons_buff_3, %of_in_mainB21_cons_buff_4, %of_in_mainB21_cons_buff_5, %of_in_mainB21_cons_buff_0, %of_in_mainB21_cons_buff_1, %of_out_mainB21_buff_1, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB21_cons_lock, Release, 1)
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      %17 = arith.addi %15, %c2 : index
      cf.br ^bb12(%17 : index)
    ^bb14:  // pred: ^bb12
      aie.use_lock(%of_in_mainB21_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      %18 = memref.load %in0_6_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB21_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb15(%c0 : index)
    ^bb15(%19: index):  // 2 preds: ^bb14, ^bb16
    ...
    ^bb16:  // pred: ^bb15
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB21_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%18, %in0_6_cons_buff_1, %of_in_mainB21_cons_buff_2, %of_in_mainB21_cons_buff_3, %of_in_mainB21_cons_buff_4, %of_in_mainB21_cons_buff_5, %of_in_mainB21_cons_buff_0, %of_out_mainB21_buff_0, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB21_cons_lock, Release, 1)
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB21_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%18, %in0_6_cons_buff_0, %of_in_mainB21_cons_buff_2, %of_in_mainB21_cons_buff_3, %of_in_mainB21_cons_buff_4, %of_in_mainB21_cons_buff_5, %of_in_mainB21_cons_buff_0, %of_out_mainB21_buff_1, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB21_cons_lock, Release, 1)
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      %21 = arith.addi %19, %c2 : index
      cf.br ^bb15(%21 : index)
    ^bb17:  // pred: ^bb15
      aie.use_lock(%of_in_mainB21_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      %22 = memref.load %in0_6_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB21_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb18(%c0 : index)
    ^bb18(%23: index):  // 2 preds: ^bb17, ^bb19
    ...
    ^bb19:  // pred: ^bb18
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB21_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%22, %in0_6_cons_buff_0, %of_in_mainB21_cons_buff_1, %of_in_mainB21_cons_buff_2, %of_in_mainB21_cons_buff_3, %of_in_mainB21_cons_buff_4, %of_in_mainB21_cons_buff_5, %of_out_mainB21_buff_0, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB21_cons_lock, Release, 1)
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB21_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%22, %in0_6_cons_buff_1, %of_in_mainB21_cons_buff_1, %of_in_mainB21_cons_buff_2, %of_in_mainB21_cons_buff_3, %of_in_mainB21_cons_buff_4, %of_in_mainB21_cons_buff_5, %of_out_mainB21_buff_1, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB21_cons_lock, Release, 1)
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      %25 = arith.addi %23, %c2 : index
      cf.br ^bb18(%25 : index)
    ...
    ^bb21:  // pred: ^bb1
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      %27 = memref.load %in0_6_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB21_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb22(%c0 : index)
    ^bb22(%28: index):  // 2 preds: ^bb21, ^bb23
    ...
    ^bb23:  // pred: ^bb22
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB21_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%27, %in0_6_cons_buff_1, %of_in_mainB21_cons_buff_0, %of_in_mainB21_cons_buff_1, %of_in_mainB21_cons_buff_2, %of_in_mainB21_cons_buff_3, %of_in_mainB21_cons_buff_4, %of_out_mainB21_buff_0, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB21_cons_lock, Release, 1)
      aie.use_lock(%in0_6_cons_prod_lock, Release, 1)
      aie.use_lock(%in0_6_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB21_prod_lock, AcquireGreaterEqual, 1)
    ...
    ^bb2:  // pred: ^bb1
      ...
      %2 = memref.load %in0_7_cons_buff_0[%c0] : memref<96xbf16>
    ...
    ^bb5:  // pred: ^bb3
      ...
      aie.use_lock(%in0_7_cons_cons_lock, AcquireGreaterEqual, 1)
      %6 = memref.load %in0_7_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_7_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB22_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb6(%c0 : index)
    ^bb6(%7: index):  // 2 preds: ^bb5, ^bb7
    ...
    ^bb8:  // pred: ^bb6
      aie.use_lock(%of_in_mainB22_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_7_cons_cons_lock, AcquireGreaterEqual, 1)
      %10 = memref.load %in0_7_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_7_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB22_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb9(%c0 : index)
    ^bb9(%11: index):  // 2 preds: ^bb8, ^bb10
    ...
    ^bb11:  // pred: ^bb9
      aie.use_lock(%of_in_mainB22_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_7_cons_cons_lock, AcquireGreaterEqual, 1)
      %14 = memref.load %in0_7_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_7_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB22_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb12(%c0 : index)
    ^bb12(%15: index):  // 2 preds: ^bb11, ^bb13
    ...
    ^bb14:  // pred: ^bb12
      aie.use_lock(%of_in_mainB22_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_7_cons_cons_lock, AcquireGreaterEqual, 1)
      %18 = memref.load %in0_7_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_7_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB22_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb15(%c0 : index)
    ^bb15(%19: index):  // 2 preds: ^bb14, ^bb16
    ...
    ^bb17:  // pred: ^bb15
      aie.use_lock(%of_in_mainB22_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_7_cons_cons_lock, AcquireGreaterEqual, 1)
      %22 = memref.load %in0_7_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_7_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB22_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb18(%c0 : index)
    ^bb18(%23: index):  // 2 preds: ^bb17, ^bb19
    ...
    ^bb21:  // pred: ^bb1
      aie.use_lock(%in0_7_cons_cons_lock, AcquireGreaterEqual, 1)
      %27 = memref.load %in0_7_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_7_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB22_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb22(%c0 : index)
    ^bb22(%28: index):  // 2 preds: ^bb21, ^bb23
    ...
    ^bb2:  // pred: ^bb1
      ...
      %2 = memref.load %in0_8_cons_buff_0[%c0] : memref<96xbf16>
    ...
    ^bb5:  // pred: ^bb3
      ...
      aie.use_lock(%in0_8_cons_cons_lock, AcquireGreaterEqual, 1)
      %6 = memref.load %in0_8_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_8_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB23_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb6(%c0 : index)
    ^bb6(%7: index):  // 2 preds: ^bb5, ^bb7
    ...
    ^bb8:  // pred: ^bb6
      aie.use_lock(%of_in_mainB23_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_8_cons_cons_lock, AcquireGreaterEqual, 1)
      %10 = memref.load %in0_8_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_8_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB23_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb9(%c0 : index)
    ^bb9(%11: index):  // 2 preds: ^bb8, ^bb10
    ...
    ^bb11:  // pred: ^bb9
      aie.use_lock(%of_in_mainB23_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_8_cons_cons_lock, AcquireGreaterEqual, 1)
      %14 = memref.load %in0_8_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_8_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB23_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb12(%c0 : index)
    ^bb12(%15: index):  // 2 preds: ^bb11, ^bb13
    ...
    ^bb14:  // pred: ^bb12
      aie.use_lock(%of_in_mainB23_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_8_cons_cons_lock, AcquireGreaterEqual, 1)
      %18 = memref.load %in0_8_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_8_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB23_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb15(%c0 : index)
    ^bb15(%19: index):  // 2 preds: ^bb14, ^bb16
    ...
    ^bb17:  // pred: ^bb15
      aie.use_lock(%of_in_mainB23_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_8_cons_cons_lock, AcquireGreaterEqual, 1)
      %22 = memref.load %in0_8_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_8_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB23_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb18(%c0 : index)
    ^bb18(%23: index):  // 2 preds: ^bb17, ^bb19
    ...
    ^bb21:  // pred: ^bb1
      aie.use_lock(%in0_8_cons_cons_lock, AcquireGreaterEqual, 1)
      %27 = memref.load %in0_8_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_8_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB23_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb22(%c0 : index)
    ^bb22(%28: index):  // 2 preds: ^bb21, ^bb23
    ...
    ^bb2:  // pred: ^bb1
      ...
      %2 = memref.load %in0_9_cons_buff_0[%c0] : memref<96xbf16>
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%in0_9_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB31_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%2, %in0_9_cons_buff_0, %of_in_mainB31_cons_buff_0, %of_in_mainB31_cons_buff_1, %of_in_mainB31_cons_buff_2, %of_in_mainB31_cons_buff_3, %of_in_mainB31_cons_buff_4, %of_out_mainB31_buff_1, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB31_cons_lock, Release, 1)
      aie.use_lock(%in0_9_cons_prod_lock, Release, 1)
      %5 = arith.addi %3, %c2 : index
      cf.br ^bb3(%5 : index)
    ^bb5:  // pred: ^bb3
      ...
      aie.use_lock(%in0_9_cons_cons_lock, AcquireGreaterEqual, 1)
      %6 = memref.load %in0_9_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_9_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB31_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb6(%c0 : index)
    ^bb6(%7: index):  // 2 preds: ^bb5, ^bb7
    ...
    ^bb8:  // pred: ^bb6
      aie.use_lock(%of_in_mainB31_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_9_cons_cons_lock, AcquireGreaterEqual, 1)
      %10 = memref.load %in0_9_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_9_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB31_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb9(%c0 : index)
    ^bb9(%11: index):  // 2 preds: ^bb8, ^bb10
    ...
    ^bb11:  // pred: ^bb9
      aie.use_lock(%of_in_mainB31_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_9_cons_cons_lock, AcquireGreaterEqual, 1)
      %14 = memref.load %in0_9_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_9_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB31_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb12(%c0 : index)
    ^bb12(%15: index):  // 2 preds: ^bb11, ^bb13
    ...
    ^bb14:  // pred: ^bb12
      aie.use_lock(%of_in_mainB31_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_9_cons_cons_lock, AcquireGreaterEqual, 1)
      %18 = memref.load %in0_9_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_9_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB31_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb15(%c0 : index)
    ^bb15(%19: index):  // 2 preds: ^bb14, ^bb16
    ...
    ^bb17:  // pred: ^bb15
      aie.use_lock(%of_in_mainB31_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_9_cons_cons_lock, AcquireGreaterEqual, 1)
      %22 = memref.load %in0_9_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_9_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB31_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb18(%c0 : index)
    ^bb18(%23: index):  // 2 preds: ^bb17, ^bb19
    ...
    ^bb19:  // pred: ^bb18
      ...
      aie.use_lock(%in0_9_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB31_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%22, %in0_9_cons_buff_1, %of_in_mainB31_cons_buff_1, %of_in_mainB31_cons_buff_2, %of_in_mainB31_cons_buff_3, %of_in_mainB31_cons_buff_4, %of_in_mainB31_cons_buff_5, %of_out_mainB31_buff_1, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB31_cons_lock, Release, 1)
      aie.use_lock(%in0_9_cons_prod_lock, Release, 1)
      %25 = arith.addi %23, %c2 : index
      cf.br ^bb18(%25 : index)
    ...
    ^bb21:  // pred: ^bb1
      aie.use_lock(%in0_9_cons_cons_lock, AcquireGreaterEqual, 1)
      %27 = memref.load %in0_9_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_9_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB31_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb22(%c0 : index)
    ^bb22(%28: index):  // 2 preds: ^bb21, ^bb23
    ...
    ^bb23:  // pred: ^bb22
      ...
      aie.use_lock(%in0_9_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_out_mainB31_prod_lock, AcquireGreaterEqual, 1)
      func.call @main_kernel(%27, %in0_9_cons_buff_0, %of_in_mainB31_cons_buff_0, %of_in_mainB31_cons_buff_1, %of_in_mainB31_cons_buff_2, %of_in_mainB31_cons_buff_3, %of_in_mainB31_cons_buff_4, %of_out_mainB31_buff_1, %c768_i32) : (bf16, memref<96xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<768xbf16>, memref<32xbf16>, i32) -> ()
      aie.use_lock(%of_out_mainB31_cons_lock, Release, 1)
      aie.use_lock(%in0_9_cons_prod_lock, Release, 1)
      %30 = arith.addi %28, %c2 : index
      cf.br ^bb22(%30 : index)
    ...
    ^bb2:  // pred: ^bb1
      ...
      %2 = memref.load %in0_10_cons_buff_0[%c0] : memref<96xbf16>
    ...
    ^bb5:  // pred: ^bb3
      ...
      aie.use_lock(%in0_10_cons_cons_lock, AcquireGreaterEqual, 1)
      %6 = memref.load %in0_10_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_10_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB32_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb6(%c0 : index)
    ^bb6(%7: index):  // 2 preds: ^bb5, ^bb7
    ...
    ^bb8:  // pred: ^bb6
      aie.use_lock(%of_in_mainB32_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_10_cons_cons_lock, AcquireGreaterEqual, 1)
      %10 = memref.load %in0_10_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_10_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB32_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb9(%c0 : index)
    ^bb9(%11: index):  // 2 preds: ^bb8, ^bb10
    ...
    ^bb11:  // pred: ^bb9
      aie.use_lock(%of_in_mainB32_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_10_cons_cons_lock, AcquireGreaterEqual, 1)
      %14 = memref.load %in0_10_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_10_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB32_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb12(%c0 : index)
    ^bb12(%15: index):  // 2 preds: ^bb11, ^bb13
    ...
    ^bb14:  // pred: ^bb12
      aie.use_lock(%of_in_mainB32_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_10_cons_cons_lock, AcquireGreaterEqual, 1)
      %18 = memref.load %in0_10_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_10_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB32_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb15(%c0 : index)
    ^bb15(%19: index):  // 2 preds: ^bb14, ^bb16
    ...
    ^bb17:  // pred: ^bb15
      aie.use_lock(%of_in_mainB32_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_10_cons_cons_lock, AcquireGreaterEqual, 1)
      %22 = memref.load %in0_10_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_10_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB32_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb18(%c0 : index)
    ^bb18(%23: index):  // 2 preds: ^bb17, ^bb19
    ...
    ^bb21:  // pred: ^bb1
      aie.use_lock(%in0_10_cons_cons_lock, AcquireGreaterEqual, 1)
      %27 = memref.load %in0_10_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_10_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB32_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb22(%c0 : index)
    ^bb22(%28: index):  // 2 preds: ^bb21, ^bb23
    ...
    ^bb2:  // pred: ^bb1
      ...
      %2 = memref.load %in0_11_cons_buff_0[%c0] : memref<96xbf16>
    ...
    ^bb5:  // pred: ^bb3
      ...
      aie.use_lock(%in0_11_cons_cons_lock, AcquireGreaterEqual, 1)
      %6 = memref.load %in0_11_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_11_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB33_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb6(%c0 : index)
    ^bb6(%7: index):  // 2 preds: ^bb5, ^bb7
    ...
    ^bb8:  // pred: ^bb6
      aie.use_lock(%of_in_mainB33_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_11_cons_cons_lock, AcquireGreaterEqual, 1)
      %10 = memref.load %in0_11_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_11_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB33_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb9(%c0 : index)
    ^bb9(%11: index):  // 2 preds: ^bb8, ^bb10
    ...
    ^bb11:  // pred: ^bb9
      aie.use_lock(%of_in_mainB33_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_11_cons_cons_lock, AcquireGreaterEqual, 1)
      %14 = memref.load %in0_11_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_11_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB33_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb12(%c0 : index)
    ^bb12(%15: index):  // 2 preds: ^bb11, ^bb13
    ...
    ^bb14:  // pred: ^bb12
      aie.use_lock(%of_in_mainB33_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_11_cons_cons_lock, AcquireGreaterEqual, 1)
      %18 = memref.load %in0_11_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_11_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB33_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb15(%c0 : index)
    ^bb15(%19: index):  // 2 preds: ^bb14, ^bb16
    ...
    ^bb17:  // pred: ^bb15
      aie.use_lock(%of_in_mainB33_cons_prod_lock, Release, 5)
      aie.use_lock(%in0_11_cons_cons_lock, AcquireGreaterEqual, 1)
      %22 = memref.load %in0_11_cons_buff_1[%c0] : memref<96xbf16>
      aie.use_lock(%in0_11_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB33_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb18(%c0 : index)
    ^bb18(%23: index):  // 2 preds: ^bb17, ^bb19
    ...
    ^bb21:  // pred: ^bb1
      aie.use_lock(%in0_11_cons_cons_lock, AcquireGreaterEqual, 1)
      %27 = memref.load %in0_11_cons_buff_0[%c0] : memref<96xbf16>
      aie.use_lock(%in0_11_cons_prod_lock, Release, 1)
      aie.use_lock(%of_in_mainB33_cons_cons_lock, AcquireGreaterEqual, 5)
      cf.br ^bb22(%c0 : index)
    ^bb22(%28: index):  // 2 preds: ^bb21, ^bb23
    ...
    memref.global "private" constant @blockwrite_data_7 : memref<8xi32> = dense<[16384, 65536, 1077936128, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_8 : memref<8xi32> = dense<[16384, 65536, 1078460416, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_9 : memref<8xi32> = dense<[16384, 65536, 1078984704, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_10 : memref<8xi32> = dense<[16384, 65536, 1079508992, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_11 : memref<8xi32> = dense<[16384, 65536, 1080033280, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_12 : memref<8xi32> = dense<[98352, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_13 : memref<8xi32> = dense<[11520, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_14 : memref<8xi32> = dense<[32768, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    aiex.runtime_sequence(%arg0: memref<23040xbf16>, %arg1: memref<23040xbf16>, %arg2: memref<23040xbf16>, %arg3: memref<23040xbf16>) {
      ...
      aiex.npu.blockwrite(%7) {address = 33673472 : ui32} : memref<8xi32>
      ...
      aiex.npu.blockwrite(%8) {address = 33673440 : ui32} : memref<8xi32>
      ...
      aiex.npu.blockwrite(%9) {address = 33673408 : ui32} : memref<8xi32>
      ...
      aiex.npu.blockwrite(%10) {address = 33673376 : ui32} : memref<8xi32>
      ...
      aiex.npu.blockwrite(%11) {address = 33673344 : ui32} : memref<8xi32>
      ...
      aiex.npu.blockwrite(%12) {address = 33673248 : ui32} : memref<8xi32>
      ...
      %14 = memref.get_global @blockwrite_data_13 : memref<8xi32>
      aiex.npu.blockwrite(%14) {address = 100782176 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 100782180 : ui32, arg_idx = 2 : i32, arg_plus = 0 : i32}
      aiex.npu.write32 {address = 119316 : ui32, column = 3 : i32, row = 0 : i32, value = 3 : ui32}
      %15 = memref.get_global @blockwrite_data_14 : memref<8xi32>
      aiex.npu.blockwrite(%15) {address = 33673216 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 33673220 : ui32, arg_idx = 3 : i32, arg_plus = 0 : i32}
