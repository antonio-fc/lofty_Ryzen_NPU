module {
  aie.device(npu1_4col) {
    ...
    %switchbox_2_1 = aie.switchbox(%mem_tile_2_1) {
      ...
      aie.connect<South : 1, DMA : 3>
      aie.connect<South : 0, DMA : 4>
      aie.connect<South : 4, DMA : 5>
    ...
    %switchbox_2_0 = aie.switchbox(%shim_noc_tile_2_0) {
      ...
      %1 = aie.amsel<1> (0)
      %2 = aie.amsel<5> (3)
      %3 = aie.masterset(South : 0, %2) {keep_pkt_header = true}
