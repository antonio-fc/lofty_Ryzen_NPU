module {
  aie.device(npu1_4col) {
    ...
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[256000, 0, 1074266112, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[98352, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_2 : memref<8xi32> = dense<[11520, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_3 : memref<8xi32> = dense<[32768, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    aiex.runtime_sequence @sequence(%arg0: memref<23040xbf16>, %arg1: memref<23040xbf16>, %arg2: memref<23040xbf16>, %arg3: memref<23040xbf16>) {
      aiex.npu.write32 {address = 213200 : ui32, column = 1 : i32, row = 2 : i32, value = 2038038528 : ui32}
      ...
      aiex.npu.blockwrite(%1) {address = 33673248 : ui32} : memref<8xi32>
