module {
  aie.device(npu1_4col) {
    ...
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[98352, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[11520, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_2 : memref<8xi32> = dense<[32768, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    aiex.runtime_sequence(%arg0: memref<23040xbf16>, %arg1: memref<23040xbf16>, %arg2: memref<23040xbf16>, %arg3: memref<23040xbf16>, %arg4: memref<23040xbf16>) {
      ...
      aiex.npu.blockwrite(%0) {address = 33673248 : ui32} : memref<8xi32>
      ...
      aiex.npu.blockwrite(%1) {address = 67227776 : ui32} : memref<8xi32>
      ...
      aiex.npu.blockwrite(%3) {address = 100782176 : ui32} : memref<8xi32>
