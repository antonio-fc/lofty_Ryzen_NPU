module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @in0(%shim_noc_tile_1_0, {%tile_0_3, %tile_0_4, %tile_0_5, %tile_1_3, %tile_1_4, %tile_1_5}, 2 : i32) : !aie.objectfifo<memref<96xbf16>> 
    aie.objectfifo @in3(%shim_noc_tile_2_0, {%tile_2_3, %tile_2_4, %tile_2_5, %tile_3_3, %tile_3_4, %tile_3_5}, 2 : i32) : !aie.objectfifo<memref<96xbf16>> 
    ...
    %core_2_3 = aie.core(%tile_2_3) {
      ...
      %c1 = arith.constant 1 : index
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        %0 = aie.objectfifo.acquire @in3(Consume, 1) : !aie.objectfifosubview<memref<96xbf16>>
        %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<96xbf16>> -> memref<96xbf16>
        %c0_0 = arith.constant 0 : index
        %2 = memref.load %1[%c0_0] : memref<96xbf16>
        ...
        %c1_2 = arith.constant 1 : index
        scf.for %arg1 = %c0_1 to %c2048 step %c1_2 {
          %9 = aie.objectfifo.acquire @in3(Consume, 1) : !aie.objectfifosubview<memref<96xbf16>>
          %10 = aie.objectfifo.subview.access %9[0] : !aie.objectfifosubview<memref<96xbf16>> -> memref<96xbf16>
