module {
  aie.device(npu1_4col) {
    ...
    %out_prod_lock_0 = aie.lock(%tile_2_2, 0) {init = 2 : i32, sym_name = "out_prod_lock_0"}
    %out_cons_lock_0 = aie.lock(%tile_2_2, 1) {init = 0 : i32, sym_name = "out_cons_lock_0"}
    ...
    %of_sub2mean_prod_lock_0 = aie.lock(%tile_1_2, 4) {init = 2 : i32, sym_name = "of_sub2mean_prod_lock_0"}
    %of_sub2mean_cons_lock_0 = aie.lock(%tile_1_2, 5) {init = 0 : i32, sym_name = "of_sub2mean_cons_lock_0"}
    ...
    %of_imag2sub_cons_prod_lock_0 = aie.lock(%tile_1_2, 2) {init = 1 : i32, sym_name = "of_imag2sub_cons_prod_lock_0"}
    %of_imag2sub_cons_cons_lock_0 = aie.lock(%tile_1_2, 3) {init = 0 : i32, sym_name = "of_imag2sub_cons_cons_lock_0"}
    %of_imag2sub_buff_0 = aie.buffer(%mem_tile_1_1) {address = 0 : i32, mem_bank = 0 : i32, sym_name = "of_imag2sub_buff_0"} : memref<4608xbf16> 
    %of_imag2sub_prod_lock_0 = aie.lock(%mem_tile_1_1, 0) {init = 1 : i32, sym_name = "of_imag2sub_prod_lock_0"}
    %of_imag2sub_cons_lock_0 = aie.lock(%mem_tile_1_1, 1) {init = 0 : i32, sym_name = "of_imag2sub_cons_lock_0"}
    %of_imag2sub_prod_lock_1 = aie.lock(%mem_tile_1_1, 2) {init = 1 : i32, sym_name = "of_imag2sub_prod_lock_1"}
    %of_imag2sub_cons_lock_1 = aie.lock(%mem_tile_1_1, 3) {init = 0 : i32, sym_name = "of_imag2sub_cons_lock_1"}
    ...
    %of_real2sub_cons_prod_lock_0 = aie.lock(%tile_1_2, 0) {init = 1 : i32, sym_name = "of_real2sub_cons_prod_lock_0"}
    %of_real2sub_cons_cons_lock_0 = aie.lock(%tile_1_2, 1) {init = 0 : i32, sym_name = "of_real2sub_cons_cons_lock_0"}
    %of_real2sub_buff_0 = aie.buffer(%mem_tile_2_1) {address = 0 : i32, mem_bank = 0 : i32, sym_name = "of_real2sub_buff_0"} : memref<4608xbf16> 
    %of_real2sub_prod_lock_0 = aie.lock(%mem_tile_2_1, 0) {init = 1 : i32, sym_name = "of_real2sub_prod_lock_0"}
    %of_real2sub_cons_lock_0 = aie.lock(%mem_tile_2_1, 1) {init = 0 : i32, sym_name = "of_real2sub_cons_lock_0"}
    %of_real2sub_prod_lock_1 = aie.lock(%mem_tile_2_1, 2) {init = 1 : i32, sym_name = "of_real2sub_prod_lock_1"}
    %of_real2sub_cons_lock_1 = aie.lock(%mem_tile_2_1, 3) {init = 0 : i32, sym_name = "of_real2sub_cons_lock_1"}
    %of_join_imag1_buff_0 = aie.buffer(%tile_3_2) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "of_join_imag1_buff_0"} : memref<2304xbf16> 
    %of_join_imag1_prod_lock_0 = aie.lock(%tile_3_2, 4) {init = 1 : i32, sym_name = "of_join_imag1_prod_lock_0"}
    %of_join_imag1_cons_lock_0 = aie.lock(%tile_3_2, 5) {init = 0 : i32, sym_name = "of_join_imag1_cons_lock_0"}
    %of_join_imag0_buff_0 = aie.buffer(%tile_0_2) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "of_join_imag0_buff_0"} : memref<2304xbf16> 
    %of_join_imag0_prod_lock_0 = aie.lock(%tile_0_2, 4) {init = 1 : i32, sym_name = "of_join_imag0_prod_lock_0"}
    %of_join_imag0_cons_lock_0 = aie.lock(%tile_0_2, 5) {init = 0 : i32, sym_name = "of_join_imag0_cons_lock_0"}
    %of_join_real1_buff_0 = aie.buffer(%tile_2_3) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "of_join_real1_buff_0"} : memref<2304xbf16> 
    %of_join_real1_prod_lock_0 = aie.lock(%tile_2_3, 4) {init = 1 : i32, sym_name = "of_join_real1_prod_lock_0"}
    %of_join_real1_cons_lock_0 = aie.lock(%tile_2_3, 5) {init = 0 : i32, sym_name = "of_join_real1_cons_lock_0"}
    %of_join_real0_buff_0 = aie.buffer(%tile_1_3) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "of_join_real0_buff_0"} : memref<2304xbf16> 
    %of_join_real0_prod_lock_0 = aie.lock(%tile_1_3, 4) {init = 1 : i32, sym_name = "of_join_real0_prod_lock_0"}
    %of_join_real0_cons_lock_0 = aie.lock(%tile_1_3, 5) {init = 0 : i32, sym_name = "of_join_real0_cons_lock_0"}
    ...
    %of_add2main1_0_cons_prod_lock_0 = aie.lock(%tile_2_3, 2) {init = 1 : i32, sym_name = "of_add2main1_0_cons_prod_lock_0"}
    %of_add2main1_0_cons_cons_lock_0 = aie.lock(%tile_2_3, 3) {init = 0 : i32, sym_name = "of_add2main1_0_cons_cons_lock_0"}
    ...
    %of_add2main1_1_cons_prod_lock_0 = aie.lock(%tile_3_2, 2) {init = 1 : i32, sym_name = "of_add2main1_1_cons_prod_lock_0"}
    %of_add2main1_1_cons_cons_lock_0 = aie.lock(%tile_3_2, 3) {init = 0 : i32, sym_name = "of_add2main1_1_cons_cons_lock_0"}
    %of_add2main1_buff_0 = aie.buffer(%tile_2_4) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_add2main1_buff_0"} : memref<4608xbf16> 
    %of_add2main1_prod_lock_0 = aie.lock(%tile_2_4, 2) {init = 1 : i32, sym_name = "of_add2main1_prod_lock_0"}
    %of_add2main1_cons_lock_0 = aie.lock(%tile_2_4, 3) {init = 0 : i32, sym_name = "of_add2main1_cons_lock_0"}
    ...
    %of_add2main0_0_cons_prod_lock_0 = aie.lock(%tile_1_3, 2) {init = 1 : i32, sym_name = "of_add2main0_0_cons_prod_lock_0"}
    %of_add2main0_0_cons_cons_lock_0 = aie.lock(%tile_1_3, 3) {init = 0 : i32, sym_name = "of_add2main0_0_cons_cons_lock_0"}
    ...
    %of_add2main0_1_cons_prod_lock_0 = aie.lock(%tile_0_2, 2) {init = 1 : i32, sym_name = "of_add2main0_1_cons_prod_lock_0"}
    %of_add2main0_1_cons_cons_lock_0 = aie.lock(%tile_0_2, 3) {init = 0 : i32, sym_name = "of_add2main0_1_cons_cons_lock_0"}
    %of_add2main0_buff_0 = aie.buffer(%tile_1_4) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_add2main0_buff_0"} : memref<4608xbf16> 
    %of_add2main0_prod_lock_0 = aie.lock(%tile_1_4, 2) {init = 1 : i32, sym_name = "of_add2main0_prod_lock_0"}
    %of_add2main0_cons_lock_0 = aie.lock(%tile_1_4, 3) {init = 0 : i32, sym_name = "of_add2main0_cons_lock_0"}
    %of_add_uv1_buff_0 = aie.buffer(%tile_2_5) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_add_uv1_buff_0"} : memref<4608xbf16> 
    %of_add_uv1_prod_lock_0 = aie.lock(%tile_2_5, 4) {init = 1 : i32, sym_name = "of_add_uv1_prod_lock_0"}
    %of_add_uv1_cons_lock_0 = aie.lock(%tile_2_5, 5) {init = 0 : i32, sym_name = "of_add_uv1_cons_lock_0"}
    %of_add_uv0_buff_0 = aie.buffer(%tile_1_5) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_add_uv0_buff_0"} : memref<4608xbf16> 
    %of_add_uv0_prod_lock_0 = aie.lock(%tile_1_5, 2) {init = 1 : i32, sym_name = "of_add_uv0_prod_lock_0"}
    %of_add_uv0_cons_lock_0 = aie.lock(%tile_1_5, 3) {init = 0 : i32, sym_name = "of_add_uv0_cons_lock_0"}
    ...
    %of_add_w1_cons_prod_lock_0 = aie.lock(%tile_2_4, 0) {init = 1 : i32, sym_name = "of_add_w1_cons_prod_lock_0"}
    %of_add_w1_cons_cons_lock_0 = aie.lock(%tile_2_4, 1) {init = 0 : i32, sym_name = "of_add_w1_cons_cons_lock_0"}
    %of_add_w1_buff_0 = aie.buffer(%tile_3_3) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "of_add_w1_buff_0"} : memref<4608xbf16> 
    %of_add_w1_prod_lock_0 = aie.lock(%tile_3_3, 4) {init = 1 : i32, sym_name = "of_add_w1_prod_lock_0"}
    %of_add_w1_cons_lock_0 = aie.lock(%tile_3_3, 5) {init = 0 : i32, sym_name = "of_add_w1_cons_lock_0"}
    ...
    %of_add_w0_cons_prod_lock_0 = aie.lock(%tile_1_4, 0) {init = 1 : i32, sym_name = "of_add_w0_cons_prod_lock_0"}
    %of_add_w0_cons_cons_lock_0 = aie.lock(%tile_1_4, 1) {init = 0 : i32, sym_name = "of_add_w0_cons_cons_lock_0"}
    %of_add_w0_buff_0 = aie.buffer(%tile_0_3) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "of_add_w0_buff_0"} : memref<4608xbf16> 
    %of_add_w0_prod_lock_0 = aie.lock(%tile_0_3, 4) {init = 1 : i32, sym_name = "of_add_w0_prod_lock_0"}
    %of_add_w0_cons_lock_0 = aie.lock(%tile_0_3, 5) {init = 0 : i32, sym_name = "of_add_w0_cons_lock_0"}
    ...
    %of_add_v1_cons_prod_lock_0 = aie.lock(%tile_2_5, 2) {init = 1 : i32, sym_name = "of_add_v1_cons_prod_lock_0"}
    %of_add_v1_cons_cons_lock_0 = aie.lock(%tile_2_5, 3) {init = 0 : i32, sym_name = "of_add_v1_cons_cons_lock_0"}
    %of_add_v1_buff_0 = aie.buffer(%tile_3_4) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "of_add_v1_buff_0"} : memref<4608xbf16> 
    %of_add_v1_prod_lock_0 = aie.lock(%tile_3_4, 4) {init = 1 : i32, sym_name = "of_add_v1_prod_lock_0"}
    %of_add_v1_cons_lock_0 = aie.lock(%tile_3_4, 5) {init = 0 : i32, sym_name = "of_add_v1_cons_lock_0"}
    ...
    %of_add_v0_cons_prod_lock_0 = aie.lock(%tile_1_5, 0) {init = 1 : i32, sym_name = "of_add_v0_cons_prod_lock_0"}
    %of_add_v0_cons_cons_lock_0 = aie.lock(%tile_1_5, 1) {init = 0 : i32, sym_name = "of_add_v0_cons_cons_lock_0"}
    %of_add_v0_buff_0 = aie.buffer(%tile_0_4) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "of_add_v0_buff_0"} : memref<4608xbf16> 
    %of_add_v0_prod_lock_0 = aie.lock(%tile_0_4, 4) {init = 1 : i32, sym_name = "of_add_v0_prod_lock_0"}
    %of_add_v0_cons_lock_0 = aie.lock(%tile_0_4, 5) {init = 0 : i32, sym_name = "of_add_v0_cons_lock_0"}
    %of_add_u1_buff_0 = aie.buffer(%tile_2_5) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "of_add_u1_buff_0"} : memref<4608xbf16> 
    %of_add_u1_prod_lock_0 = aie.lock(%tile_2_5, 0) {init = 1 : i32, sym_name = "of_add_u1_prod_lock_0"}
    %of_add_u1_cons_lock_0 = aie.lock(%tile_2_5, 1) {init = 0 : i32, sym_name = "of_add_u1_cons_lock_0"}
    %of_add_u0_buff_0 = aie.buffer(%tile_0_5) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "of_add_u0_buff_0"} : memref<4608xbf16> 
    %of_add_u0_prod_lock_0 = aie.lock(%tile_0_5, 4) {init = 1 : i32, sym_name = "of_add_u0_prod_lock_0"}
    %of_add_u0_cons_lock_0 = aie.lock(%tile_0_5, 5) {init = 0 : i32, sym_name = "of_add_u0_cons_lock_0"}
    ...
    %of_in_main14_cons_prod_lock_0 = aie.lock(%tile_3_3, 2) {init = 1 : i32, sym_name = "of_in_main14_cons_prod_lock_0"}
    %of_in_main14_cons_cons_lock_0 = aie.lock(%tile_3_3, 3) {init = 0 : i32, sym_name = "of_in_main14_cons_cons_lock_0"}
    ...
    %of_in_main13_cons_prod_lock_0 = aie.lock(%tile_3_4, 2) {init = 1 : i32, sym_name = "of_in_main13_cons_prod_lock_0"}
    %of_in_main13_cons_cons_lock_0 = aie.lock(%tile_3_4, 3) {init = 0 : i32, sym_name = "of_in_main13_cons_cons_lock_0"}
    ...
    %of_in_main12_cons_prod_lock_0 = aie.lock(%tile_3_5, 2) {init = 1 : i32, sym_name = "of_in_main12_cons_prod_lock_0"}
    %of_in_main12_cons_cons_lock_0 = aie.lock(%tile_3_5, 3) {init = 0 : i32, sym_name = "of_in_main12_cons_cons_lock_0"}
    ...
    %of_in_main11_cons_prod_lock_0 = aie.lock(%tile_3_2, 0) {init = 1 : i32, sym_name = "of_in_main11_cons_prod_lock_0"}
    %of_in_main11_cons_cons_lock_0 = aie.lock(%tile_3_2, 1) {init = 0 : i32, sym_name = "of_in_main11_cons_cons_lock_0"}
    ...
    %of_in_main10_cons_prod_lock_0 = aie.lock(%tile_2_3, 0) {init = 1 : i32, sym_name = "of_in_main10_cons_prod_lock_0"}
    %of_in_main10_cons_cons_lock_0 = aie.lock(%tile_2_3, 1) {init = 0 : i32, sym_name = "of_in_main10_cons_cons_lock_0"}
    ...
    %of_in_main04_cons_prod_lock_0 = aie.lock(%tile_0_3, 2) {init = 1 : i32, sym_name = "of_in_main04_cons_prod_lock_0"}
    %of_in_main04_cons_cons_lock_0 = aie.lock(%tile_0_3, 3) {init = 0 : i32, sym_name = "of_in_main04_cons_cons_lock_0"}
    ...
    %of_in_main03_cons_prod_lock_0 = aie.lock(%tile_0_4, 2) {init = 1 : i32, sym_name = "of_in_main03_cons_prod_lock_0"}
    %of_in_main03_cons_cons_lock_0 = aie.lock(%tile_0_4, 3) {init = 0 : i32, sym_name = "of_in_main03_cons_cons_lock_0"}
    ...
    %of_in_main02_cons_prod_lock_0 = aie.lock(%tile_0_5, 2) {init = 1 : i32, sym_name = "of_in_main02_cons_prod_lock_0"}
    %of_in_main02_cons_cons_lock_0 = aie.lock(%tile_0_5, 3) {init = 0 : i32, sym_name = "of_in_main02_cons_cons_lock_0"}
    ...
    %of_in_main01_cons_prod_lock_0 = aie.lock(%tile_0_2, 0) {init = 1 : i32, sym_name = "of_in_main01_cons_prod_lock_0"}
    %of_in_main01_cons_cons_lock_0 = aie.lock(%tile_0_2, 1) {init = 0 : i32, sym_name = "of_in_main01_cons_cons_lock_0"}
    ...
    %of_in_main00_cons_prod_lock_0 = aie.lock(%tile_1_3, 0) {init = 1 : i32, sym_name = "of_in_main00_cons_prod_lock_0"}
    %of_in_main00_cons_cons_lock_0 = aie.lock(%tile_1_3, 1) {init = 0 : i32, sym_name = "of_in_main00_cons_cons_lock_0"}
    ...
    %in0_0_cons_prod_lock_0 = aie.lock(%tile_0_5, 0) {init = 2 : i32, sym_name = "in0_0_cons_prod_lock_0"}
    %in0_0_cons_cons_lock_0 = aie.lock(%tile_0_5, 1) {init = 0 : i32, sym_name = "in0_0_cons_cons_lock_0"}
    ...
    %in0_2_cons_prod_lock_0 = aie.lock(%tile_0_3, 0) {init = 2 : i32, sym_name = "in0_2_cons_prod_lock_0"}
    %in0_2_cons_cons_lock_0 = aie.lock(%tile_0_3, 1) {init = 0 : i32, sym_name = "in0_2_cons_cons_lock_0"}
    ...
    %in0_3_cons_prod_lock_0 = aie.lock(%tile_3_5, 0) {init = 2 : i32, sym_name = "in0_3_cons_prod_lock_0"}
    %in0_3_cons_cons_lock_0 = aie.lock(%tile_3_5, 1) {init = 0 : i32, sym_name = "in0_3_cons_cons_lock_0"}
    ...
    %in0_4_cons_prod_lock_0 = aie.lock(%tile_3_4, 0) {init = 2 : i32, sym_name = "in0_4_cons_prod_lock_0"}
    %in0_4_cons_cons_lock_0 = aie.lock(%tile_3_4, 1) {init = 0 : i32, sym_name = "in0_4_cons_cons_lock_0"}
    ...
    %in0_5_cons_prod_lock_0 = aie.lock(%tile_3_3, 0) {init = 2 : i32, sym_name = "in0_5_cons_prod_lock_0"}
    %in0_5_cons_cons_lock_0 = aie.lock(%tile_3_3, 1) {init = 0 : i32, sym_name = "in0_5_cons_cons_lock_0"}
    ...
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_main02_cons_cons_lock_0, AcquireGreaterEqual, 1)
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%of_add_u0_prod_lock_0, AcquireGreaterEqual, 1)
      ...
      aie.use_lock(%of_add_u0_cons_lock_0, Release, 1)
      aie.use_lock(%of_add_u0_prod_lock_0, AcquireGreaterEqual, 1)
      ...
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_main02_cons_prod_lock_0, Release, 1)
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb5
      ...
      cf.cond_br %1, ^bb2, ^bb6
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_main03_cons_cons_lock_0, AcquireGreaterEqual, 1)
      %c0_0 = arith.constant 0 : index
      %c2048 = arith.constant 2048 : index
      %c1_1 = arith.constant 1 : index
      %c2 = arith.constant 2 : index
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%of_add_v0_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      %c32_i32 = arith.constant 32 : i32
      %c0_i32 = arith.constant 0 : i32
      %c1_i32 = arith.constant 1 : i32
      ...
      aie.use_lock(%of_add_v0_cons_lock_0, Release, 1)
      aie.use_lock(%of_add_v0_prod_lock_0, AcquireGreaterEqual, 1)
      ...
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_main03_cons_prod_lock_0, Release, 1)
      %5 = arith.addi %0, %c1 : index
      cf.br ^bb1(%5 : index)
    ^bb6:  // pred: ^bb1
      aie.end
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb5
      ...
      cf.cond_br %1, ^bb2, ^bb6
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_main04_cons_cons_lock_0, AcquireGreaterEqual, 1)
      %c0_0 = arith.constant 0 : index
      %c2048 = arith.constant 2048 : index
      %c1_1 = arith.constant 1 : index
      %c2 = arith.constant 2 : index
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%of_add_w0_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      %c32_i32 = arith.constant 32 : i32
      %c0_i32 = arith.constant 0 : i32
      %c2_i32 = arith.constant 2 : i32
      ...
      aie.use_lock(%of_add_w0_cons_lock_0, Release, 1)
      aie.use_lock(%of_add_w0_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32_2 = arith.constant 4608 : i32
      %c32_i32_3 = arith.constant 32 : i32
      %c1_i32 = arith.constant 1 : i32
      ...
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_main04_cons_prod_lock_0, Release, 1)
      %5 = arith.addi %0, %c1 : index
      cf.br ^bb1(%5 : index)
    ^bb6:  // pred: ^bb1
      aie.end
    ...
    ^bb2:  // pred: ^bb1
      ...
      cf.br ^bb3(%c0_0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      %3 = arith.cmpi slt, %2, %c65536 : index
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_add_u0_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_add_v0_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_add_uv0_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      ...
      aie.use_lock(%of_add_uv0_cons_lock_0, Release, 1)
      aie.use_lock(%of_add_u0_prod_lock_0, Release, 1)
      aie.use_lock(%of_add_v0_cons_prod_lock_0, Release, 1)
    ...
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_add_w0_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_add_uv0_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_add2main0_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      ...
      aie.use_lock(%of_add2main0_cons_lock_0, Release, 1)
      aie.use_lock(%of_add_w0_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_add_uv0_prod_lock_0, Release, 1)
      %4 = arith.addi %2, %c1_1 : index
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      %5 = arith.addi %0, %c1 : index
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb5
      ...
      cf.cond_br %1, ^bb2, ^bb6
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_main00_cons_cons_lock_0, AcquireGreaterEqual, 1)
      %c0_0 = arith.constant 0 : index
      %c65536 = arith.constant 65536 : index
      %c1_1 = arith.constant 1 : index
      cf.br ^bb3(%c0_0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_add2main0_0_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_join_real0_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      %c0_i32 = arith.constant 0 : i32
      ...
      aie.use_lock(%of_join_real0_cons_lock_0, Release, 1)
      aie.use_lock(%of_add2main0_0_cons_prod_lock_0, Release, 1)
      %4 = arith.addi %2, %c1_1 : index
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_main00_cons_prod_lock_0, Release, 1)
      %5 = arith.addi %0, %c1 : index
      cf.br ^bb1(%5 : index)
    ^bb6:  // pred: ^bb1
      aie.end
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb5
      ...
      cf.cond_br %1, ^bb2, ^bb6
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_main01_cons_cons_lock_0, AcquireGreaterEqual, 1)
      %c0_0 = arith.constant 0 : index
      %c65536 = arith.constant 65536 : index
      %c1_1 = arith.constant 1 : index
      cf.br ^bb3(%c0_0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_add2main0_1_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_join_imag0_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      %c1_i32 = arith.constant 1 : i32
      ...
      aie.use_lock(%of_join_imag0_cons_lock_0, Release, 1)
      aie.use_lock(%of_add2main0_1_cons_prod_lock_0, Release, 1)
      %4 = arith.addi %2, %c1_1 : index
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_main01_cons_prod_lock_0, Release, 1)
      %5 = arith.addi %0, %c1 : index
      cf.br ^bb1(%5 : index)
    ^bb6:  // pred: ^bb1
      aie.end
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb5
      ...
      cf.cond_br %1, ^bb2, ^bb6
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_main12_cons_cons_lock_0, AcquireGreaterEqual, 1)
      %c0_0 = arith.constant 0 : index
      %c2048 = arith.constant 2048 : index
      %c1_1 = arith.constant 1 : index
      %c2 = arith.constant 2 : index
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%of_add_u1_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      %c32_i32 = arith.constant 32 : i32
      %c0_i32 = arith.constant 0 : i32
      %c0_i32_2 = arith.constant 0 : i32
      ...
      aie.use_lock(%of_add_u1_cons_lock_0, Release, 1)
      aie.use_lock(%of_add_u1_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32_3 = arith.constant 4608 : i32
      %c32_i32_4 = arith.constant 32 : i32
      %c1_i32 = arith.constant 1 : i32
      ...
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_main12_cons_prod_lock_0, Release, 1)
      %5 = arith.addi %0, %c1 : index
      cf.br ^bb1(%5 : index)
    ^bb6:  // pred: ^bb1
      aie.end
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb5
      ...
      cf.cond_br %1, ^bb2, ^bb6
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_main13_cons_cons_lock_0, AcquireGreaterEqual, 1)
      %c0_0 = arith.constant 0 : index
      %c2048 = arith.constant 2048 : index
      %c1_1 = arith.constant 1 : index
      %c2 = arith.constant 2 : index
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%of_add_v1_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      %c32_i32 = arith.constant 32 : i32
      %c0_i32 = arith.constant 0 : i32
      %c1_i32 = arith.constant 1 : i32
      ...
      aie.use_lock(%of_add_v1_cons_lock_0, Release, 1)
      aie.use_lock(%of_add_v1_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32_2 = arith.constant 4608 : i32
      %c32_i32_3 = arith.constant 32 : i32
      %c1_i32_4 = arith.constant 1 : i32
      ...
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_main13_cons_prod_lock_0, Release, 1)
      %5 = arith.addi %0, %c1 : index
      cf.br ^bb1(%5 : index)
    ^bb6:  // pred: ^bb1
      aie.end
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb5
      ...
      cf.cond_br %1, ^bb2, ^bb6
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_main14_cons_cons_lock_0, AcquireGreaterEqual, 1)
      %c0_0 = arith.constant 0 : index
      %c2048 = arith.constant 2048 : index
      %c1_1 = arith.constant 1 : index
      %c2 = arith.constant 2 : index
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%of_add_w1_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      %c32_i32 = arith.constant 32 : i32
      %c0_i32 = arith.constant 0 : i32
      %c2_i32 = arith.constant 2 : i32
      ...
      aie.use_lock(%of_add_w1_cons_lock_0, Release, 1)
      aie.use_lock(%of_add_w1_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32_2 = arith.constant 4608 : i32
      %c32_i32_3 = arith.constant 32 : i32
      %c1_i32 = arith.constant 1 : i32
      ...
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_main14_cons_prod_lock_0, Release, 1)
      %5 = arith.addi %0, %c1 : index
      cf.br ^bb1(%5 : index)
    ^bb6:  // pred: ^bb1
      aie.end
    ...
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_add_u1_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_add_v1_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_add_uv1_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      ...
      aie.use_lock(%of_add_uv1_cons_lock_0, Release, 1)
      aie.use_lock(%of_add_u1_prod_lock_0, Release, 1)
      aie.use_lock(%of_add_v1_cons_prod_lock_0, Release, 1)
      %4 = arith.addi %2, %c1_1 : index
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      %5 = arith.addi %0, %c1 : index
    ...
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_add_w1_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_add_uv1_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_add2main1_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      ...
      aie.use_lock(%of_add2main1_cons_lock_0, Release, 1)
      aie.use_lock(%of_add_w1_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_add_uv1_prod_lock_0, Release, 1)
      %4 = arith.addi %2, %c1_1 : index
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      %5 = arith.addi %0, %c1 : index
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb5
      ...
      cf.cond_br %1, ^bb2, ^bb6
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_main10_cons_cons_lock_0, AcquireGreaterEqual, 1)
      %c0_0 = arith.constant 0 : index
      %c65536 = arith.constant 65536 : index
      %c1_1 = arith.constant 1 : index
      cf.br ^bb3(%c0_0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_add2main1_0_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_join_real1_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      %c0_i32 = arith.constant 0 : i32
      ...
      aie.use_lock(%of_join_real1_cons_lock_0, Release, 1)
      aie.use_lock(%of_add2main1_0_cons_prod_lock_0, Release, 1)
      %4 = arith.addi %2, %c1_1 : index
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_main10_cons_prod_lock_0, Release, 1)
      %5 = arith.addi %0, %c1 : index
      cf.br ^bb1(%5 : index)
    ^bb6:  // pred: ^bb1
      aie.end
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb5
      ...
      cf.cond_br %1, ^bb2, ^bb6
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_main11_cons_cons_lock_0, AcquireGreaterEqual, 1)
      %c0_0 = arith.constant 0 : index
      %c65536 = arith.constant 65536 : index
      %c1_1 = arith.constant 1 : index
      cf.br ^bb3(%c0_0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_add2main1_1_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_join_imag1_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      %c1_i32 = arith.constant 1 : i32
      ...
      aie.use_lock(%of_join_imag1_cons_lock_0, Release, 1)
      aie.use_lock(%of_add2main1_1_cons_prod_lock_0, Release, 1)
      %4 = arith.addi %2, %c1_1 : index
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_main11_cons_prod_lock_0, Release, 1)
      %5 = arith.addi %0, %c1 : index
      cf.br ^bb1(%5 : index)
    ^bb6:  // pred: ^bb1
      aie.end
    ...
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_real2sub_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_imag2sub_cons_cons_lock_0, AcquireGreaterEqual, 1)
      ...
      aie.use_lock(%of_real2sub_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_imag2sub_cons_prod_lock_0, Release, 1)
      aie.use_lock(%of_real2sub_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_imag2sub_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%of_sub2mean_prod_lock_0, AcquireGreaterEqual, 1)
      %c4608_i32_2 = arith.constant 4608 : i32
    ...
    aiex.runtime_sequence @sequence(%arg0: memref<23050xbf16>, %arg1: memref<23050xbf16>, %arg2: memref<23050xbf16>, %arg3: memref<23050xbf16>) {
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 1, 1, 196608][0, 0, 0, 1]) {id = 1 : i64, metadata = @in0} : memref<23050xbf16>
      ...
      aiex.npu.dma_memcpy_nd(%arg3[0, 0, 0, 0][1, 1, 1, 65536][0, 0, 0, 1]) {id = 0 : i64, metadata = @out} : memref<23050xbf16>
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      aie.use_lock(%of_in_main02_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_main02_cons_buff_0 : memref<4610xbf16>, 0, 4610) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_in_main02_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb5:  // pred: ^bb3
      aie.end
    }
    ...
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb5)
    ^bb4:  // 2 preds: ^bb3, ^bb4
      aie.use_lock(%of_in_main03_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_main03_cons_buff_0 : memref<4610xbf16>, 0, 4610) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_in_main03_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb5:  // pred: ^bb3
      %2 = aie.dma_start(MM2S, 0, ^bb6, ^bb7)
    ^bb6:  // 2 preds: ^bb5, ^bb6
      aie.use_lock(%of_add_v0_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add_v0_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 3 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%of_add_v0_prod_lock_0, Release, 1)
      aie.next_bd ^bb6
    ^bb7:  // pred: ^bb5
      aie.end
    }
    ...
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb5)
    ^bb4:  // 2 preds: ^bb3, ^bb4
      aie.use_lock(%of_in_main04_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_main04_cons_buff_0 : memref<4610xbf16>, 0, 4610) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_in_main04_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb5:  // pred: ^bb3
      %2 = aie.dma_start(MM2S, 0, ^bb6, ^bb7)
    ^bb6:  // 2 preds: ^bb5, ^bb6
      aie.use_lock(%of_add_w0_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add_w0_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 3 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%of_add_w0_prod_lock_0, Release, 1)
      aie.next_bd ^bb6
    ^bb7:  // pred: ^bb5
      aie.end
    }
    ...
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb5)
    ^bb4:  // 2 preds: ^bb3, ^bb4
      aie.use_lock(%of_in_main12_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_main12_cons_buff_0 : memref<4610xbf16>, 0, 4610) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_in_main12_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb5:  // pred: ^bb3
      aie.end
    }
    ...
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb5)
    ^bb4:  // 2 preds: ^bb3, ^bb4
      aie.use_lock(%of_in_main13_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_main13_cons_buff_0 : memref<4610xbf16>, 0, 4610) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_in_main13_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb5:  // pred: ^bb3
      %2 = aie.dma_start(MM2S, 0, ^bb6, ^bb7)
    ^bb6:  // 2 preds: ^bb5, ^bb6
      aie.use_lock(%of_add_v1_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add_v1_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 3 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%of_add_v1_prod_lock_0, Release, 1)
      aie.next_bd ^bb6
    ^bb7:  // pred: ^bb5
      aie.end
    }
    ...
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb5)
    ^bb4:  // 2 preds: ^bb3, ^bb4
      aie.use_lock(%of_in_main14_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_main14_cons_buff_0 : memref<4610xbf16>, 0, 4610) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_in_main14_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb5:  // pred: ^bb3
      %2 = aie.dma_start(MM2S, 0, ^bb6, ^bb7)
    ^bb6:  // 2 preds: ^bb5, ^bb6
      aie.use_lock(%of_add_w1_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add_w1_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 3 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%of_add_w1_prod_lock_0, Release, 1)
      aie.next_bd ^bb6
    ^bb7:  // pred: ^bb5
      aie.end
    }
    ...
    %memtile_dma_0_1 = aie.memtile_dma(%mem_tile_0_1) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb11)
    ^bb1:  // 2 preds: ^bb0, ^bb10
      aie.use_lock(%in1_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_0 : memref<23050xbf16>, 0, 4610) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%in1_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%in1_cons_prod_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_0 : memref<23050xbf16>, 4610, 4610) {bd_id = 1 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%in1_cons_cons_lock_1, Release, 1)
      aie.next_bd ^bb3
    ^bb3:  // pred: ^bb2
      aie.use_lock(%in1_cons_prod_lock_2, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_0 : memref<23050xbf16>, 9220, 4610) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%in1_cons_cons_lock_2, Release, 1)
      aie.next_bd ^bb4
    ^bb4:  // pred: ^bb3
      aie.use_lock(%in1_cons_prod_lock_3, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_0 : memref<23050xbf16>, 13830, 4610) {bd_id = 3 : i32, next_bd_id = 4 : i32}
      aie.use_lock(%in1_cons_cons_lock_3, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%in1_cons_prod_lock_4, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_0 : memref<23050xbf16>, 18440, 4610) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%in1_cons_cons_lock_4, Release, 1)
      aie.next_bd ^bb6
    ^bb6:  // pred: ^bb5
      aie.use_lock(%in1_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_1 : memref<23050xbf16>, 0, 4610) {bd_id = 5 : i32, next_bd_id = 6 : i32}
      aie.use_lock(%in1_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb7
    ^bb7:  // pred: ^bb6
      aie.use_lock(%in1_cons_prod_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_1 : memref<23050xbf16>, 4610, 4610) {bd_id = 6 : i32, next_bd_id = 7 : i32}
      aie.use_lock(%in1_cons_cons_lock_1, Release, 1)
      aie.next_bd ^bb8
    ^bb8:  // pred: ^bb7
      aie.use_lock(%in1_cons_prod_lock_2, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_1 : memref<23050xbf16>, 9220, 4610) {bd_id = 7 : i32, next_bd_id = 8 : i32}
      aie.use_lock(%in1_cons_cons_lock_2, Release, 1)
      aie.next_bd ^bb9
    ^bb9:  // pred: ^bb8
      aie.use_lock(%in1_cons_prod_lock_3, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_1 : memref<23050xbf16>, 13830, 4610) {bd_id = 8 : i32, next_bd_id = 9 : i32}
      aie.use_lock(%in1_cons_cons_lock_3, Release, 1)
      aie.next_bd ^bb10
    ^bb10:  // pred: ^bb9
      aie.use_lock(%in1_cons_prod_lock_4, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_1 : memref<23050xbf16>, 18440, 4610) {bd_id = 9 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%in1_cons_cons_lock_4, Release, 1)
      aie.next_bd ^bb1
    ^bb11:  // pred: ^bb0
      %1 = aie.dma_start(MM2S, 0, ^bb12, ^bb14)
    ^bb12:  // 2 preds: ^bb11, ^bb13
      aie.use_lock(%in1_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_0 : memref<23050xbf16>, 0, 4610) {bd_id = 10 : i32, next_bd_id = 11 : i32}
      aie.use_lock(%in1_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb13
    ^bb13:  // pred: ^bb12
      aie.use_lock(%in1_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_1 : memref<23050xbf16>, 0, 4610) {bd_id = 11 : i32, next_bd_id = 10 : i32}
      aie.use_lock(%in1_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb12
    ^bb14:  // pred: ^bb11
      %2 = aie.dma_start(MM2S, 1, ^bb15, ^bb17)
    ...
    ^bb16:  // pred: ^bb15
      ...
      aie.next_bd ^bb15
    ^bb17:  // pred: ^bb14
      %3 = aie.dma_start(MM2S, 2, ^bb18, ^bb20)
    ^bb18:  // 2 preds: ^bb17, ^bb19
      aie.use_lock(%in1_cons_cons_lock_2, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_0 : memref<23050xbf16>, 9220, 4610) {bd_id = 12 : i32, next_bd_id = 13 : i32}
      aie.use_lock(%in1_cons_prod_lock_2, Release, 1)
      aie.next_bd ^bb19
    ^bb19:  // pred: ^bb18
      aie.use_lock(%in1_cons_cons_lock_2, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_1 : memref<23050xbf16>, 9220, 4610) {bd_id = 13 : i32, next_bd_id = 12 : i32}
      aie.use_lock(%in1_cons_prod_lock_2, Release, 1)
      aie.next_bd ^bb18
    ^bb20:  // pred: ^bb17
      %4 = aie.dma_start(MM2S, 3, ^bb21, ^bb23)
    ...
    ^bb22:  // pred: ^bb21
      ...
      aie.next_bd ^bb21
    ^bb23:  // pred: ^bb20
      %5 = aie.dma_start(MM2S, 4, ^bb24, ^bb26)
    ^bb24:  // 2 preds: ^bb23, ^bb25
      aie.use_lock(%in1_cons_cons_lock_4, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_0 : memref<23050xbf16>, 18440, 4610) {bd_id = 14 : i32, next_bd_id = 15 : i32}
      aie.use_lock(%in1_cons_prod_lock_4, Release, 1)
      aie.next_bd ^bb25
    ^bb25:  // pred: ^bb24
      aie.use_lock(%in1_cons_cons_lock_4, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_1 : memref<23050xbf16>, 18440, 4610) {bd_id = 15 : i32, next_bd_id = 14 : i32}
      aie.use_lock(%in1_cons_prod_lock_4, Release, 1)
      aie.next_bd ^bb24
    ^bb26:  // pred: ^bb23
      aie.end
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb10
      ...
      aie.dma_bd(%in2_cons_buff_0 : memref<23050xbf16>, 0, 4610) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%in2_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%in2_cons_prod_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_0 : memref<23050xbf16>, 4610, 4610) {bd_id = 1 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%in2_cons_cons_lock_1, Release, 1)
      aie.next_bd ^bb3
    ^bb3:  // pred: ^bb2
      aie.use_lock(%in2_cons_prod_lock_2, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_0 : memref<23050xbf16>, 9220, 4610) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%in2_cons_cons_lock_2, Release, 1)
      aie.next_bd ^bb4
    ^bb4:  // pred: ^bb3
      aie.use_lock(%in2_cons_prod_lock_3, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_0 : memref<23050xbf16>, 13830, 4610) {bd_id = 3 : i32, next_bd_id = 4 : i32}
      aie.use_lock(%in2_cons_cons_lock_3, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%in2_cons_prod_lock_4, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_0 : memref<23050xbf16>, 18440, 4610) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%in2_cons_cons_lock_4, Release, 1)
      aie.next_bd ^bb6
    ^bb6:  // pred: ^bb5
      aie.use_lock(%in2_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_1 : memref<23050xbf16>, 0, 4610) {bd_id = 5 : i32, next_bd_id = 6 : i32}
      aie.use_lock(%in2_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb7
    ^bb7:  // pred: ^bb6
      aie.use_lock(%in2_cons_prod_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_1 : memref<23050xbf16>, 4610, 4610) {bd_id = 6 : i32, next_bd_id = 7 : i32}
      aie.use_lock(%in2_cons_cons_lock_1, Release, 1)
      aie.next_bd ^bb8
    ^bb8:  // pred: ^bb7
      aie.use_lock(%in2_cons_prod_lock_2, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_1 : memref<23050xbf16>, 9220, 4610) {bd_id = 7 : i32, next_bd_id = 8 : i32}
      aie.use_lock(%in2_cons_cons_lock_2, Release, 1)
      aie.next_bd ^bb9
    ^bb9:  // pred: ^bb8
      aie.use_lock(%in2_cons_prod_lock_3, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_1 : memref<23050xbf16>, 13830, 4610) {bd_id = 8 : i32, next_bd_id = 9 : i32}
      aie.use_lock(%in2_cons_cons_lock_3, Release, 1)
      aie.next_bd ^bb10
    ^bb10:  // pred: ^bb9
      aie.use_lock(%in2_cons_prod_lock_4, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_1 : memref<23050xbf16>, 18440, 4610) {bd_id = 9 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%in2_cons_cons_lock_4, Release, 1)
      aie.next_bd ^bb1
    ^bb11:  // pred: ^bb0
      %1 = aie.dma_start(MM2S, 0, ^bb12, ^bb14)
    ^bb12:  // 2 preds: ^bb11, ^bb13
      ...
      aie.dma_bd(%in2_cons_buff_0 : memref<23050xbf16>, 0, 4610) {bd_id = 10 : i32, next_bd_id = 11 : i32}
      aie.use_lock(%in2_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb13
    ^bb13:  // pred: ^bb12
      aie.use_lock(%in2_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_1 : memref<23050xbf16>, 0, 4610) {bd_id = 11 : i32, next_bd_id = 10 : i32}
      aie.use_lock(%in2_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb12
    ^bb14:  // pred: ^bb11
      %2 = aie.dma_start(MM2S, 1, ^bb15, ^bb17)
    ...
    ^bb18:  // 2 preds: ^bb17, ^bb19
      ...
      aie.dma_bd(%in2_cons_buff_0 : memref<23050xbf16>, 9220, 4610) {bd_id = 12 : i32, next_bd_id = 13 : i32}
      aie.use_lock(%in2_cons_prod_lock_2, Release, 1)
      aie.next_bd ^bb19
    ^bb19:  // pred: ^bb18
      aie.use_lock(%in2_cons_cons_lock_2, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_1 : memref<23050xbf16>, 9220, 4610) {bd_id = 13 : i32, next_bd_id = 12 : i32}
      aie.use_lock(%in2_cons_prod_lock_2, Release, 1)
      aie.next_bd ^bb18
    ^bb20:  // pred: ^bb17
      %4 = aie.dma_start(MM2S, 3, ^bb21, ^bb23)
    ...
    ^bb24:  // 2 preds: ^bb23, ^bb25
      ...
      aie.dma_bd(%in2_cons_buff_0 : memref<23050xbf16>, 18440, 4610) {bd_id = 14 : i32, next_bd_id = 15 : i32}
      aie.use_lock(%in2_cons_prod_lock_4, Release, 1)
      aie.next_bd ^bb25
    ^bb25:  // pred: ^bb24
      aie.use_lock(%in2_cons_cons_lock_4, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_1 : memref<23050xbf16>, 18440, 4610) {bd_id = 15 : i32, next_bd_id = 14 : i32}
      aie.use_lock(%in2_cons_prod_lock_4, Release, 1)
      aie.next_bd ^bb24
    ^bb26:  // pred: ^bb23
      aie.end
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_in_main00_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_main00_cons_buff_0 : memref<4610xbf16>, 0, 4610) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_in_main00_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb3, ^bb4)
    ^bb3:  // 2 preds: ^bb2, ^bb3
      aie.use_lock(%of_add2main0_0_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add2main0_0_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 1 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_add2main0_0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb3
    ^bb4:  // pred: ^bb2
      %2 = aie.dma_start(MM2S, 0, ^bb5, ^bb6)
    ^bb5:  // 2 preds: ^bb4, ^bb5
      aie.use_lock(%of_join_real0_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_join_real0_buff_0 : memref<2304xbf16>, 0, 2304) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_join_real0_prod_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb6:  // pred: ^bb4
      aie.end
    }
    %mem_0_2 = aie.mem(%tile_0_2) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_in_main01_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_main01_cons_buff_0 : memref<4610xbf16>, 0, 4610) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_in_main01_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb3, ^bb4)
    ^bb3:  // 2 preds: ^bb2, ^bb3
      aie.use_lock(%of_add2main0_1_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add2main0_1_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 1 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_add2main0_1_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb3
    ^bb4:  // pred: ^bb2
      %2 = aie.dma_start(MM2S, 0, ^bb5, ^bb6)
    ^bb5:  // 2 preds: ^bb4, ^bb5
      aie.use_lock(%of_join_imag0_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_join_imag0_buff_0 : memref<2304xbf16>, 0, 2304) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_join_imag0_prod_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb6:  // pred: ^bb4
      aie.end
    }
    %mem_2_3 = aie.mem(%tile_2_3) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_in_main10_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_main10_cons_buff_0 : memref<4610xbf16>, 0, 4610) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_in_main10_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb3, ^bb4)
    ^bb3:  // 2 preds: ^bb2, ^bb3
      aie.use_lock(%of_add2main1_0_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add2main1_0_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 1 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_add2main1_0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb3
    ^bb4:  // pred: ^bb2
      %2 = aie.dma_start(MM2S, 0, ^bb5, ^bb6)
    ^bb5:  // 2 preds: ^bb4, ^bb5
      aie.use_lock(%of_join_real1_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_join_real1_buff_0 : memref<2304xbf16>, 0, 2304) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_join_real1_prod_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb6:  // pred: ^bb4
      aie.end
    }
    %mem_3_2 = aie.mem(%tile_3_2) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_in_main11_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_main11_cons_buff_0 : memref<4610xbf16>, 0, 4610) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_in_main11_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb3, ^bb4)
    ^bb3:  // 2 preds: ^bb2, ^bb3
      aie.use_lock(%of_add2main1_1_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add2main1_1_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 1 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_add2main1_1_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb3
    ^bb4:  // pred: ^bb2
      %2 = aie.dma_start(MM2S, 0, ^bb5, ^bb6)
    ^bb5:  // 2 preds: ^bb4, ^bb5
      aie.use_lock(%of_join_imag1_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_join_imag1_buff_0 : memref<2304xbf16>, 0, 2304) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_join_imag1_prod_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb6:  // pred: ^bb4
      aie.end
    }
    %mem_1_5 = aie.mem(%tile_1_5) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_add_v0_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add_v0_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_add_v0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      aie.end
    }
    %mem_2_5 = aie.mem(%tile_2_5) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_add_v1_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add_v1_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_add_v1_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      aie.end
    }
    %mem_1_4 = aie.mem(%tile_1_4) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_add_w0_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add_w0_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_add_w0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      %1 = aie.dma_start(MM2S, 0, ^bb3, ^bb4)
    ^bb3:  // 2 preds: ^bb2, ^bb3
      aie.use_lock(%of_add2main0_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add2main0_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 1 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_add2main0_prod_lock_0, Release, 1)
      aie.next_bd ^bb3
    ^bb4:  // pred: ^bb2
      aie.end
    }
    %mem_2_4 = aie.mem(%tile_2_4) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_add_w1_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add_w1_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_add_w1_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      %1 = aie.dma_start(MM2S, 0, ^bb3, ^bb4)
    ^bb3:  // 2 preds: ^bb2, ^bb3
      aie.use_lock(%of_add2main1_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_add2main1_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 1 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_add2main1_prod_lock_0, Release, 1)
      aie.next_bd ^bb3
    ^bb4:  // pred: ^bb2
      aie.end
    }
    %memtile_dma_2_1 = aie.memtile_dma(%mem_tile_2_1) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_real2sub_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_real2sub_buff_0 : memref<4608xbf16>, 0, 2304) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_real2sub_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb3, ^bb4)
    ^bb3:  // 2 preds: ^bb2, ^bb3
      aie.use_lock(%of_real2sub_prod_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_real2sub_buff_0 : memref<4608xbf16>, 2304, 2304) {bd_id = 24 : i32, next_bd_id = 24 : i32}
      aie.use_lock(%of_real2sub_cons_lock_1, Release, 1)
      aie.next_bd ^bb3
    ^bb4:  // pred: ^bb2
      %2 = aie.dma_start(MM2S, 0, ^bb5, ^bb7)
    ^bb5:  // 2 preds: ^bb4, ^bb6
      aie.use_lock(%of_real2sub_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_real2sub_buff_0 : memref<4608xbf16>, 0, 2304) {bd_id = 1 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_real2sub_prod_lock_0, Release, 1)
      aie.next_bd ^bb6
    ^bb6:  // pred: ^bb5
      aie.use_lock(%of_real2sub_cons_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_real2sub_buff_0 : memref<4608xbf16>, 2304, 2304) {bd_id = 2 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_real2sub_prod_lock_1, Release, 1)
      aie.next_bd ^bb5
    ^bb7:  // pred: ^bb4
      aie.end
    }
    %memtile_dma_1_1 = aie.memtile_dma(%mem_tile_1_1) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_imag2sub_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_imag2sub_buff_0 : memref<4608xbf16>, 0, 2304) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_imag2sub_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb3, ^bb4)
    ^bb3:  // 2 preds: ^bb2, ^bb3
      aie.use_lock(%of_imag2sub_prod_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_imag2sub_buff_0 : memref<4608xbf16>, 2304, 2304) {bd_id = 24 : i32, next_bd_id = 24 : i32}
      aie.use_lock(%of_imag2sub_cons_lock_1, Release, 1)
      aie.next_bd ^bb3
    ^bb4:  // pred: ^bb2
      %2 = aie.dma_start(MM2S, 0, ^bb5, ^bb7)
    ^bb5:  // 2 preds: ^bb4, ^bb6
      aie.use_lock(%of_imag2sub_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_imag2sub_buff_0 : memref<4608xbf16>, 0, 2304) {bd_id = 1 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_imag2sub_prod_lock_0, Release, 1)
      aie.next_bd ^bb6
    ^bb6:  // pred: ^bb5
      aie.use_lock(%of_imag2sub_cons_lock_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_imag2sub_buff_0 : memref<4608xbf16>, 2304, 2304) {bd_id = 2 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_imag2sub_prod_lock_1, Release, 1)
      aie.next_bd ^bb5
    ^bb7:  // pred: ^bb4
      aie.end
    }
    %mem_1_2 = aie.mem(%tile_1_2) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_real2sub_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_real2sub_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_real2sub_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb3, ^bb4)
    ^bb3:  // 2 preds: ^bb2, ^bb3
      aie.use_lock(%of_imag2sub_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_imag2sub_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 1 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_imag2sub_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb3
    ^bb4:  // pred: ^bb2
      aie.end
    }
