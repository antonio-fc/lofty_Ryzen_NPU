module {
  aie.device(npu1_4col) {
    func.func private @vector_scale(memref<1xbf16>, memref<1xbf16>, memref<2xbf16>, i32)
    func.func private @passthrough(memref<1xbf16>, memref<1xbf16>, i32)
    func.func private @vector_add(memref<1xbf16>, memref<1xbf16>, memref<1xbf16>, i32)
    func.func private @vector_mult(memref<1xbf16>, memref<1xbf16>, memref<1xbf16>, i32)
    func.func private @mean(memref<1xbf16>, memref<2xbf16>, i32, i32)
    func.func private @sin_float_1024(memref<1xbf16>, memref<1xbf16>, i32)
    func.func private @cos_float_1024(memref<1xbf16>, memref<1xbf16>, i32)
    func.func private @vector_sub(memref<1xbf16>, memref<1xbf16>, memref<1xbf16>, i32)
    ...
    aie.objectfifo @in1(%shim_noc_tile_3_0, {%mem_tile_3_1}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @in2(%shim_noc_tile_1_0, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<3xbf16>> 
    aie.objectfifo @in3(%shim_noc_tile_1_0, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<6xbf16>> 
    aie.objectfifo @visR(%mem_tile_3_1, {%tile_3_4}, 2 : i32) : !aie.objectfifo<memref<1xbf16>> 
    aie.objectfifo @visC(%mem_tile_3_1, {%tile_3_5}, 2 : i32) : !aie.objectfifo<memref<1xbf16>> 
    aie.objectfifo.link [@in1] -> [@visR, @visC]([] [0, 1])
    aie.objectfifo @u(%mem_tile_1_1, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<1xbf16>> 
    aie.objectfifo @v(%mem_tile_1_1, {%tile_1_2}, 2 : i32) : !aie.objectfifo<memref<1xbf16>> 
    aie.objectfifo @w(%mem_tile_1_1, {%tile_2_2}, 2 : i32) : !aie.objectfifo<memref<1xbf16>> 
    aie.objectfifo.link [@in2] -> [@u, @v, @w]([] [0, 1, 2])
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c9216 step %c1_1 {
          %2 = aie.objectfifo.acquire @u(Consume, 1) : !aie.objectfifosubview<memref<1xbf16>>
    ...
    %core_1_2 = aie.core(%tile_1_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c9216 step %c1_1 {
          %2 = aie.objectfifo.acquire @v(Consume, 1) : !aie.objectfifosubview<memref<1xbf16>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1xbf16>> -> memref<1xbf16>
    ...
    %core_2_2 = aie.core(%tile_2_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c9216 step %c1_1 {
          %2 = aie.objectfifo.acquire @w(Consume, 1) : !aie.objectfifosubview<memref<1xbf16>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1xbf16>> -> memref<1xbf16>
    ...
    %core_3_5 = aie.core(%tile_3_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c9216 step %c1_1 {
          %0 = aie.objectfifo.acquire @visC(Consume, 1) : !aie.objectfifosubview<memref<1xbf16>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1xbf16>> -> memref<1xbf16>
    ...
    %core_3_4 = aie.core(%tile_3_4) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c9216 step %c1_1 {
          %0 = aie.objectfifo.acquire @visR(Consume, 1) : !aie.objectfifosubview<memref<1xbf16>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1xbf16>> -> memref<1xbf16>
