...
.preheader3:                                      ; preds = %.preheader3, %.new
  %niter = phi i64 [ 0, %.new ], [ %niter.next.3, %.preheader3 ]
  ...
  %niter.next.3 = add nuw nsw i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, 4611686018427387900
  br i1 %niter.ncmp.3, label %.preheader3.epil, label %.preheader3

.preheader3.epil:                                 ; preds = %.preheader3, %.preheader3.epil
  %epil.iter = phi i64 [ %epil.iter.next, %.preheader3.epil ], [ 0, %.preheader3 ]
  tail call void @llvm.aie2.acquire(i32 49, i32 -1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.acquire(i32 49, i32 -1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  ...
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, 3
  br i1 %epil.iter.cmp.not, label %.preheader.preheader, label %.preheader3.epil, !llvm.loop !3

.preheader.preheader:                             ; preds = %.preheader3.epil
  tail call void @llvm.aie2.acquire(i32 49, i32 -1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.acquire(i32 49, i32 -1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
...
.preheader3.epil:                                 ; preds = %.preheader3, %.preheader3.epil
  ...
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, 3
  br i1 %epil.iter.cmp.not, label %.preheader.preheader, label %.preheader3.epil, !llvm.loop !4
...
0:                                                ; preds = %0, %.new
  %niter = phi i64 [ 0, %.new ], [ %niter.next.1, %0 ]
  ...
  br i1 %niter.ncmp.1, label %.epilog-lcssa, label %0

.epilog-lcssa:                                    ; preds = %0
  tail call void @llvm.aie2.acquire(i32 51, i32 -1)
  tail call void @llvm.aie2.acquire(i32 49, i32 -1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.acquire(i32 49, i32 -1)
