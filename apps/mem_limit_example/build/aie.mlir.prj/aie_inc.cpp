...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd0), /* addrA */ 0x0,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd1), /* addrA */ 0x4000,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile35_bd0), /* addrA */ 0x400,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile35_bd1), /* addrA */ 0x4000,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd2), /* addrA */ 0x400,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd3), /* addrA */ 0x4000,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile12_bd2), /* addrA */ 0x400,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile12_bd3), /* addrA */ 0x4000,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd2), /* addrA */ 0x400,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd3), /* addrA */ 0x4000,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd0), /* addrA */ 0x80000,  /* len */ 8));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd2), /* addrA */ 0x80000,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd24), /* addrA */ 0x80004,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd25), /* addrA */ 0x90004,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd3), /* addrA */ 0x90000,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd1), /* addrA */ 0x90000,  /* len */ 8));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd0), /* addrA */ 0x80000,  /* len */ 12));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd2), /* addrA */ 0x80000,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd24), /* addrA */ 0x80004,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd4), /* addrA */ 0x80008,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd5), /* addrA */ 0x90008,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd25), /* addrA */ 0x90004,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd3), /* addrA */ 0x90000,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd1), /* addrA */ 0x90000,  /* len */ 12));
...
// buffer in1_cons_buff_0 with unsupported type memref<4xbf16>;
// buffer in1_cons_buff_1 with unsupported type memref<4xbf16>;
// buffer visC_cons_buff_0 with unsupported type memref<2xbf16>;
// buffer visC_cons_buff_1 with unsupported type memref<2xbf16>;
// buffer visR_cons_buff_0 with unsupported type memref<2xbf16>;
// buffer visR_cons_buff_1 with unsupported type memref<2xbf16>;
...
// buffer u_cons_buff_0 with unsupported type memref<2xbf16>;
// buffer u_cons_buff_1 with unsupported type memref<2xbf16>;
// buffer n_cons_buff_0 with unsupported type memref<2xbf16>;
// buffer n_cons_buff_1 with unsupported type memref<2xbf16>;
// buffer w_cons_buff_0 with unsupported type memref<2xbf16>;
// buffer w_cons_buff_1 with unsupported type memref<2xbf16>;
// buffer m_cons_buff_0 with unsupported type memref<2xbf16>;
// buffer m_cons_buff_1 with unsupported type memref<2xbf16>;
// buffer v_cons_buff_0 with unsupported type memref<2xbf16>;
// buffer v_cons_buff_1 with unsupported type memref<2xbf16>;
// buffer out_buff_0 with unsupported type memref<2xbf16>;
// buffer out_buff_1 with unsupported type memref<2xbf16>;
// buffer in2_cons_buff_0 with unsupported type memref<6xbf16>;
// buffer in2_cons_buff_1 with unsupported type memref<6xbf16>;
