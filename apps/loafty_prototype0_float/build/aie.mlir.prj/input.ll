...
@in1_cons_buff_0 = external global [2048 x float]
...
@of_mean = external global [1024 x float]
@of_subFc_cons = external global [1024 x float]
@of_subFc = external global [1024 x float]
@of_subFr = external global [1024 x float]
@of_multEc = external global [1024 x float]
@of_multEr = external global [1024 x float]
@of_sincosD_0_cons = external global [1024 x float]
@of_sincosD_1_cons = external global [1024 x float]
@of_sincosD = external global [1024 x float]
@of_scaleC = external global [1024 x float]
@addB1 = external global [1024 x float]
@addB0_cons = external global [1024 x float]
@addB0 = external global [1024 x float]
@addA1 = external global [1024 x float]
@addA0_cons = external global [1024 x float]
...
@visC_cons = external global [1024 x float]
@visC = external global [1024 x float]
@visR_cons = external global [1024 x float]
@visR = external global [1024 x float]
...
@in1_cons = external global [2048 x float]
@in1 = external global [2048 x float]
...
declare void @vector_sub_aie_scalar(ptr, ptr, ptr, i32)
...
7:                                                ; preds = %4
  ...
  call void @vector_sub_aie_scalar(ptr @of_subFr_buff_0, ptr @of_subFc_cons_buff_0, ptr @of_mean_buff_0, i32 1024)
  ...
  call void @vector_sub_aie_scalar(ptr @of_subFr_buff_1, ptr @of_subFc_cons_buff_1, ptr @of_mean_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 51, i32 1)
  call void @llvm.aie2.release(i32 34, i32 1)
  call void @llvm.aie2.release(i32 48, i32 1)
  %8 = add i64 %5, 2
...
7:                                                ; preds = %4
  ...
  call void @vector_mult_aie_scalar(ptr @of_multEr_buff_0, ptr @visR_cons_buff_0, ptr @of_subFr_buff_0, i32 1024)
  call void @llvm.aie2.release(i32 51, i32 1)
  ...
  call void @vector_mult_aie_scalar(ptr @of_multEr_buff_1, ptr @visR_cons_buff_1, ptr @of_subFr_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 51, i32 1)
  call void @llvm.aie2.release(i32 18, i32 1)
  call void @llvm.aie2.release(i32 48, i32 1)
  %8 = add i64 %5, 2
...
7:                                                ; preds = %4
  ...
  call void @vector_mult_aie_scalar(ptr @of_multEc_buff_0, ptr @visC_cons_buff_0, ptr @of_subFc_buff_0, i32 1024)
  call void @llvm.aie2.release(i32 51, i32 1)
  call void @llvm.aie2.release(i32 18, i32 1)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.acquire(i32 19, i32 -1)
  ...
  call void @vector_mult_aie_scalar(ptr @of_multEc_buff_1, ptr @visC_cons_buff_1, ptr @of_subFc_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 51, i32 1)
  call void @llvm.aie2.release(i32 18, i32 1)
  call void @llvm.aie2.release(i32 48, i32 1)
  %8 = add i64 %5, 2
...
8:                                                ; preds = %5
  ...
  call void @vector_scalar_mul_aie_scalar(ptr @of_scaleC_buff_0, ptr @of_sincosD_buff_0, ptr @in0_cons_buff_0, i32 1024)
  ...
  call void @llvm.assume(i1 true) [ "align"(ptr @in0_cons_buff_0, i64 32) ]
  call void @vector_scalar_mul_aie_scalar(ptr @of_scaleC_buff_1, ptr @of_sincosD_buff_1, ptr @in0_cons_buff_0, i32 1024)
  call void @llvm.aie2.release(i32 53, i32 1)
  call void @llvm.aie2.release(i32 50, i32 1)
  %9 = add i64 %6, 2
  br label %5
...
14:                                               ; preds = %11
  ...
  call void @vector_scalar_mul_aie_scalar(ptr @of_scaleC_buff_1, ptr @of_sincosD_buff_1, ptr @in0_cons_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 53, i32 1)
  call void @llvm.aie2.release(i32 50, i32 1)
  call void @llvm.aie2.acquire(i32 51, i32 -1)
  call void @llvm.aie2.acquire(i32 52, i32 -1)
  ...
  call void @llvm.assume(i1 true) [ "align"(ptr @of_scaleC_buff_0, i64 32) ]
  call void @llvm.assume(i1 true) [ "align"(ptr @in0_cons_buff_1, i64 32) ]
  call void @vector_scalar_mul_aie_scalar(ptr @of_scaleC_buff_0, ptr @of_sincosD_buff_0, ptr @in0_cons_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 53, i32 1)
  call void @llvm.aie2.release(i32 50, i32 1)
  %15 = add i64 %12, 2
  br label %11
...
7:                                                ; preds = %4
  ...
  call void @vector_add_aie_scalar(ptr @addB0_cons_buff_0, ptr @addB1_buff_0, ptr @of_scaleC_buff_0, i32 1024)
  ...
  call void @vector_add_aie_scalar(ptr @addB0_cons_buff_1, ptr @addB1_buff_1, ptr @of_scaleC_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 19, i32 1)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 50, i32 1)
  %8 = add i64 %5, 2
...
7:                                                ; preds = %4
  ...
  call void @vector_add_aie_scalar(ptr @addA0_cons_buff_0, ptr @addA1_buff_0, ptr @addB1_buff_0, i32 1024)
  call void @llvm.aie2.release(i32 19, i32 1)
  call void @llvm.aie2.release(i32 48, i32 1)
  ...
  call void @vector_add_aie_scalar(ptr @addA0_cons_buff_1, ptr @addA1_buff_1, ptr @addB1_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 19, i32 1)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 4, i32 1)
  %8 = add i64 %5, 2
