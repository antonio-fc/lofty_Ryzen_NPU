; ModuleID = '/notebooks/my_mlir-aie/apps/loafty_prototype0_float/build/aie.mlir.prj/input.ll'
...
declare void @vector_sub_aie_scalar(ptr, ptr, ptr, i32) local_unnamed_addr
...
.preheader3:                                      ; preds = %0, %.preheader3
  ...
  tail call void @vector_sub_aie_scalar(ptr nonnull @of_subFr_buff_0, ptr nonnull @of_subFc_cons_buff_0, ptr nonnull @of_mean_buff_0, i32 1024)
  ...
  tail call void @vector_sub_aie_scalar(ptr nonnull @of_subFr_buff_1, ptr nonnull @of_subFc_cons_buff_1, ptr nonnull @of_mean_buff_1, i32 1024)
  tail call void @llvm.aie2.release(i32 51, i32 1)
  tail call void @llvm.aie2.release(i32 34, i32 1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.acquire(i32 35, i32 -1)
...
.preheader3:                                      ; preds = %0, %.preheader3
  ...
  tail call void @vector_mult_aie_scalar(ptr nonnull @of_multEr_buff_0, ptr nonnull @visR_cons_buff_0, ptr nonnull @of_subFr_buff_0, i32 1024)
  tail call void @llvm.aie2.release(i32 51, i32 1)
  ...
  tail call void @vector_mult_aie_scalar(ptr nonnull @of_multEr_buff_1, ptr nonnull @visR_cons_buff_1, ptr nonnull @of_subFr_buff_1, i32 1024)
  tail call void @llvm.aie2.release(i32 51, i32 1)
  tail call void @llvm.aie2.release(i32 18, i32 1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.acquire(i32 19, i32 -1)
...
.preheader3:                                      ; preds = %0, %.preheader3
  ...
  tail call void @vector_mult_aie_scalar(ptr nonnull @of_multEc_buff_0, ptr nonnull @visC_cons_buff_0, ptr nonnull @of_subFc_buff_0, i32 1024)
  tail call void @llvm.aie2.release(i32 51, i32 1)
  tail call void @llvm.aie2.release(i32 18, i32 1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.acquire(i32 19, i32 -1)
  ...
  tail call void @vector_mult_aie_scalar(ptr nonnull @of_multEc_buff_1, ptr nonnull @visC_cons_buff_1, ptr nonnull @of_subFc_buff_1, i32 1024)
  tail call void @llvm.aie2.release(i32 51, i32 1)
  tail call void @llvm.aie2.release(i32 18, i32 1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.acquire(i32 19, i32 -1)
...
1:                                                ; preds = %0, %1
  ...
  tail call void @vector_scalar_mul_aie_scalar(ptr nonnull @of_scaleC_buff_0, ptr nonnull @of_sincosD_buff_0, ptr nonnull @in0_cons_buff_0, i32 1024)
  ...
  call void @llvm.assume(i1 true) [ "align"(ptr @in0_cons_buff_0, i64 32) ]
  tail call void @vector_scalar_mul_aie_scalar(ptr nonnull @of_scaleC_buff_1, ptr nonnull @of_sincosD_buff_1, ptr nonnull @in0_cons_buff_0, i32 1024)
  tail call void @llvm.aie2.release(i32 53, i32 1)
  tail call void @llvm.aie2.release(i32 50, i32 1)
  tail call void @llvm.aie2.acquire(i32 51, i32 -1)
  tail call void @llvm.aie2.acquire(i32 52, i32 -1)
  ...
  tail call void @vector_scalar_mul_aie_scalar(ptr nonnull @of_scaleC_buff_1, ptr nonnull @of_sincosD_buff_1, ptr nonnull @in0_cons_buff_1, i32 1024)
  tail call void @llvm.aie2.release(i32 53, i32 1)
  tail call void @llvm.aie2.release(i32 50, i32 1)
  tail call void @llvm.aie2.acquire(i32 51, i32 -1)
  tail call void @llvm.aie2.acquire(i32 52, i32 -1)
  ...
  call void @llvm.assume(i1 true) [ "align"(ptr @of_scaleC_buff_0, i64 32) ]
  call void @llvm.assume(i1 true) [ "align"(ptr @in0_cons_buff_1, i64 32) ]
  tail call void @vector_scalar_mul_aie_scalar(ptr nonnull @of_scaleC_buff_0, ptr nonnull @of_sincosD_buff_0, ptr nonnull @in0_cons_buff_1, i32 1024)
  tail call void @llvm.aie2.release(i32 53, i32 1)
  tail call void @llvm.aie2.release(i32 50, i32 1)
  tail call void @llvm.aie2.acquire(i32 51, i32 -1)
  tail call void @llvm.aie2.acquire(i32 52, i32 -1)
