module {
  aie.device(npu1_4col) {
    ...
    memref.global "public" @of_scaleAddBL_cons : memref<4608xbf16>
    ...
    memref.global "public" @in3_cons : memref<96xbf16>
    ...
    %of_sub2mean_prod_lock = aie.lock(%tile_2_2, 0) {init = 1 : i32, sym_name = "of_sub2mean_prod_lock"}
    %of_sub2mean_cons_lock = aie.lock(%tile_2_2, 1) {init = 0 : i32, sym_name = "of_sub2mean_cons_lock"}
    %of_reduc2SubC_buff_0 = aie.buffer(%tile_3_3) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_reduc2SubC_buff_0"} : memref<4608xbf16> 
    %of_reduc2SubC_prod_lock = aie.lock(%tile_3_3, 0) {init = 1 : i32, sym_name = "of_reduc2SubC_prod_lock"}
    %of_reduc2SubC_cons_lock = aie.lock(%tile_3_3, 1) {init = 0 : i32, sym_name = "of_reduc2SubC_cons_lock"}
    ...
    %of_reduc2SubR_cons_prod_lock = aie.lock(%tile_3_2, 0) {init = 1 : i32, sym_name = "of_reduc2SubR_cons_prod_lock"}
    %of_reduc2SubR_cons_cons_lock = aie.lock(%tile_3_2, 1) {init = 0 : i32, sym_name = "of_reduc2SubR_cons_cons_lock"}
    %of_reduc2SubR_buff_0 = aie.buffer(%tile_2_3) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_reduc2SubR_buff_0"} : memref<4608xbf16> 
    %of_reduc2SubR_prod_lock = aie.lock(%tile_2_3, 0) {init = 1 : i32, sym_name = "of_reduc2SubR_prod_lock"}
    %of_reduc2SubR_cons_lock = aie.lock(%tile_2_3, 1) {init = 0 : i32, sym_name = "of_reduc2SubR_cons_lock"}
    ...
    %of_reduceC_prod_lock = aie.lock(%tile_3_4, 2) {init = 2 : i32, sym_name = "of_reduceC_prod_lock"}
    %of_reduceC_cons_lock = aie.lock(%tile_3_4, 3) {init = 0 : i32, sym_name = "of_reduceC_cons_lock"}
    ...
    %of_reduceR_prod_lock = aie.lock(%tile_2_4, 2) {init = 2 : i32, sym_name = "of_reduceR_prod_lock"}
    %of_reduceR_cons_lock = aie.lock(%tile_2_4, 3) {init = 0 : i32, sym_name = "of_reduceR_cons_lock"}
    %of_multTrigC_buff_0 = aie.buffer(%tile_3_5) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_multTrigC_buff_0"} : memref<4608xbf16> 
    %of_multTrigC_prod_lock = aie.lock(%tile_3_5, 2) {init = 1 : i32, sym_name = "of_multTrigC_prod_lock"}
    %of_multTrigC_cons_lock = aie.lock(%tile_3_5, 3) {init = 0 : i32, sym_name = "of_multTrigC_cons_lock"}
    %of_multTrigR_buff_0 = aie.buffer(%tile_2_5) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_multTrigR_buff_0"} : memref<4608xbf16> 
    %of_multTrigR_prod_lock = aie.lock(%tile_2_5, 2) {init = 1 : i32, sym_name = "of_multTrigR_prod_lock"}
    %of_multTrigR_cons_lock = aie.lock(%tile_2_5, 3) {init = 0 : i32, sym_name = "of_multTrigR_cons_lock"}
    ...
    %of_trigFifo_0_cons_prod_lock = aie.lock(%tile_2_5, 0) {init = 1 : i32, sym_name = "of_trigFifo_0_cons_prod_lock"}
    %of_trigFifo_0_cons_cons_lock = aie.lock(%tile_2_5, 1) {init = 0 : i32, sym_name = "of_trigFifo_0_cons_cons_lock"}
    ...
    %of_trigFifo_1_cons_prod_lock = aie.lock(%tile_3_5, 0) {init = 1 : i32, sym_name = "of_trigFifo_1_cons_prod_lock"}
    %of_trigFifo_1_cons_cons_lock = aie.lock(%tile_3_5, 1) {init = 0 : i32, sym_name = "of_trigFifo_1_cons_cons_lock"}
    %of_trigFifo_buff_0 = aie.buffer(%tile_1_2) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_trigFifo_buff_0"} : memref<4608xbf16> 
    %of_trigFifo_prod_lock = aie.lock(%tile_1_2, 4) {init = 1 : i32, sym_name = "of_trigFifo_prod_lock"}
    %of_trigFifo_cons_lock = aie.lock(%tile_1_2, 5) {init = 0 : i32, sym_name = "of_trigFifo_cons_lock"}
    %of_scaleAddBL_cons_buff_0 = aie.buffer(%tile_1_2) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "of_scaleAddBL_cons_buff_0"} : memref<4608xbf16> 
    %of_scaleAddBL_cons_prod_lock = aie.lock(%tile_1_2, 2) {init = 1 : i32, sym_name = "of_scaleAddBL_cons_prod_lock"}
    %of_scaleAddBL_cons_cons_lock = aie.lock(%tile_1_2, 3) {init = 0 : i32, sym_name = "of_scaleAddBL_cons_cons_lock"}
    %of_scaleAddBL_buff_0 = aie.buffer(%tile_1_4) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_scaleAddBL_buff_0"} : memref<4608xbf16> 
    %of_scaleAddBL_prod_lock = aie.lock(%tile_1_4, 2) {init = 1 : i32, sym_name = "of_scaleAddBL_prod_lock"}
    %of_scaleAddBL_cons_lock = aie.lock(%tile_1_4, 3) {init = 0 : i32, sym_name = "of_scaleAddBL_cons_lock"}
    %of_addUV_buff_0 = aie.buffer(%tile_1_5) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_addUV_buff_0"} : memref<4608xbf16> 
    %of_addUV_prod_lock = aie.lock(%tile_1_5, 2) {init = 1 : i32, sym_name = "of_addUV_prod_lock"}
    %of_addUV_cons_lock = aie.lock(%tile_1_5, 3) {init = 0 : i32, sym_name = "of_addUV_cons_lock"}
    ...
    %of_addW_cons_prod_lock = aie.lock(%tile_1_4, 0) {init = 2 : i32, sym_name = "of_addW_cons_prod_lock"}
    %of_addW_cons_cons_lock = aie.lock(%tile_1_4, 1) {init = 0 : i32, sym_name = "of_addW_cons_cons_lock"}
    %of_addW_buff_0 = aie.buffer(%tile_0_3) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_addW_buff_0"} : memref<4608xbf16> 
    %of_addW_prod_lock = aie.lock(%tile_0_3, 4) {init = 1 : i32, sym_name = "of_addW_prod_lock"}
    %of_addW_cons_lock = aie.lock(%tile_0_3, 5) {init = 0 : i32, sym_name = "of_addW_cons_lock"}
    %of_addV_cons_buff_0 = aie.buffer(%tile_1_5) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "of_addV_cons_buff_0"} : memref<4608xbf16> 
    %of_addV_cons_prod_lock = aie.lock(%tile_1_5, 0) {init = 1 : i32, sym_name = "of_addV_cons_prod_lock"}
    %of_addV_cons_cons_lock = aie.lock(%tile_1_5, 1) {init = 0 : i32, sym_name = "of_addV_cons_cons_lock"}
    %of_addV_buff_0 = aie.buffer(%tile_0_4) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_addV_buff_0"} : memref<4608xbf16> 
    %of_addV_prod_lock = aie.lock(%tile_0_4, 4) {init = 1 : i32, sym_name = "of_addV_prod_lock"}
    %of_addV_cons_lock = aie.lock(%tile_0_4, 5) {init = 0 : i32, sym_name = "of_addV_cons_lock"}
    %of_addU_buff_0 = aie.buffer(%tile_0_5) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "of_addU_buff_0"} : memref<4608xbf16> 
    %of_addU_prod_lock = aie.lock(%tile_0_5, 4) {init = 1 : i32, sym_name = "of_addU_prod_lock"}
    %of_addU_cons_lock = aie.lock(%tile_0_5, 5) {init = 0 : i32, sym_name = "of_addU_cons_lock"}
    ...
    %of_in_visC_cons_prod_lock = aie.lock(%tile_3_4, 0) {init = 2 : i32, sym_name = "of_in_visC_cons_prod_lock"}
    %of_in_visC_cons_cons_lock = aie.lock(%tile_3_4, 1) {init = 0 : i32, sym_name = "of_in_visC_cons_cons_lock"}
    ...
    %of_in_visR_cons_prod_lock = aie.lock(%tile_2_4, 0) {init = 2 : i32, sym_name = "of_in_visR_cons_prod_lock"}
    %of_in_visR_cons_cons_lock = aie.lock(%tile_2_4, 1) {init = 0 : i32, sym_name = "of_in_visR_cons_cons_lock"}
    %of_in_n_cons_buff_0 = aie.buffer(%tile_0_3) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "of_in_n_cons_buff_0"} : memref<32xbf16> 
    %of_in_n_cons_prod_lock = aie.lock(%tile_0_3, 2) {init = 1 : i32, sym_name = "of_in_n_cons_prod_lock"}
    %of_in_n_cons_cons_lock = aie.lock(%tile_0_3, 3) {init = 0 : i32, sym_name = "of_in_n_cons_cons_lock"}
    %of_in_m_cons_buff_0 = aie.buffer(%tile_0_4) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "of_in_m_cons_buff_0"} : memref<32xbf16> 
    %of_in_m_cons_prod_lock = aie.lock(%tile_0_4, 2) {init = 1 : i32, sym_name = "of_in_m_cons_prod_lock"}
    %of_in_m_cons_cons_lock = aie.lock(%tile_0_4, 3) {init = 0 : i32, sym_name = "of_in_m_cons_cons_lock"}
    %of_in_l_cons_buff_0 = aie.buffer(%tile_0_5) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "of_in_l_cons_buff_0"} : memref<32xbf16> 
    %of_in_l_cons_prod_lock = aie.lock(%tile_0_5, 2) {init = 1 : i32, sym_name = "of_in_l_cons_prod_lock"}
    %of_in_l_cons_cons_lock = aie.lock(%tile_0_5, 3) {init = 0 : i32, sym_name = "of_in_l_cons_cons_lock"}
    ...
    %of_in_w_cons_prod_lock = aie.lock(%tile_0_3, 0) {init = 2 : i32, sym_name = "of_in_w_cons_prod_lock"}
    %of_in_w_cons_cons_lock = aie.lock(%tile_0_3, 1) {init = 0 : i32, sym_name = "of_in_w_cons_cons_lock"}
    ...
    %of_in_v_cons_prod_lock = aie.lock(%tile_0_4, 0) {init = 2 : i32, sym_name = "of_in_v_cons_prod_lock"}
    %of_in_v_cons_cons_lock = aie.lock(%tile_0_4, 1) {init = 0 : i32, sym_name = "of_in_v_cons_cons_lock"}
    ...
    %of_in_u_cons_prod_lock = aie.lock(%tile_0_5, 0) {init = 2 : i32, sym_name = "of_in_u_cons_prod_lock"}
    %of_in_u_cons_cons_lock = aie.lock(%tile_0_5, 1) {init = 0 : i32, sym_name = "of_in_u_cons_cons_lock"}
    %in3_cons_buff_0 = aie.buffer(%mem_tile_3_1) {address = 0 : i32, mem_bank = 0 : i32, sym_name = "in3_cons_buff_0"} : memref<96xbf16> 
    %in3_cons_buff_1 = aie.buffer(%mem_tile_3_1) {address = 65536 : i32, mem_bank = 1 : i32, sym_name = "in3_cons_buff_1"} : memref<96xbf16> 
    %in3_cons_prod_lock = aie.lock(%mem_tile_3_1, 0) {init = 6 : i32, sym_name = "in3_cons_prod_lock"}
    %in3_cons_cons_lock = aie.lock(%mem_tile_3_1, 1) {init = 0 : i32, sym_name = "in3_cons_cons_lock"}
    %in3_prod_lock = aie.lock(%shim_noc_tile_3_0, 0) {init = 1 : i32, sym_name = "in3_prod_lock"}
    %in3_cons_lock = aie.lock(%shim_noc_tile_3_0, 1) {init = 0 : i32, sym_name = "in3_cons_lock"}
    ...
    %in2_cons_prod_lock = aie.lock(%mem_tile_2_1, 0) {init = 4 : i32, sym_name = "in2_cons_prod_lock"}
    ...
    %in0_cons_buff_0 = aie.buffer(%tile_1_2) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "in0_cons_buff_0"} : memref<2xbf16> 
    %in0_cons_buff_1 = aie.buffer(%tile_1_2) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "in0_cons_buff_1"} : memref<2xbf16> 
    %in0_cons_prod_lock = aie.lock(%tile_1_2, 0) {init = 2 : i32, sym_name = "in0_cons_prod_lock"}
    %in0_cons_cons_lock = aie.lock(%tile_1_2, 1) {init = 0 : i32, sym_name = "in0_cons_cons_lock"}
    ...
    aie.flow(%tile_1_4, DMA : 0, %tile_1_2, DMA : 1)
    aie.flow(%tile_1_2, DMA : 0, %tile_3_5, DMA : 0)
    aie.flow(%tile_1_2, DMA : 0, %tile_2_5, DMA : 0)
    ...
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_u_cons_cons_lock, AcquireGreaterEqual, 2)
    ...
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_in_l_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_addU_prod_lock, AcquireGreaterEqual, 1)
      ...
      aie.use_lock(%of_addU_cons_lock, Release, 1)
      aie.use_lock(%of_addU_prod_lock, AcquireGreaterEqual, 1)
      ...
      aie.use_lock(%of_addU_cons_lock, Release, 1)
      aie.use_lock(%of_in_l_cons_prod_lock, Release, 1)
      %4 = arith.addi %2, %c1_1 : index
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_u_cons_prod_lock, Release, 2)
      aie.use_lock(%of_in_u_cons_cons_lock, AcquireGreaterEqual, 2)
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb8
      ...
      cf.cond_br %1, ^bb2, ^bb9
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_v_cons_cons_lock, AcquireGreaterEqual, 2)
      %c0_0 = arith.constant 0 : index
      %c512 = arith.constant 512 : index
      %c1_1 = arith.constant 1 : index
      cf.br ^bb3(%c0_0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_in_m_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_addV_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      %c0_i32 = arith.constant 0 : i32
      ...
      aie.use_lock(%of_addV_cons_lock, Release, 1)
      aie.use_lock(%of_addV_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32_2 = arith.constant 4608 : i32
      %c0_i32_3 = arith.constant 0 : i32
      ...
      aie.use_lock(%of_addV_cons_lock, Release, 1)
      aie.use_lock(%of_in_m_cons_prod_lock, Release, 1)
      %4 = arith.addi %2, %c1_1 : index
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_v_cons_prod_lock, Release, 2)
      aie.use_lock(%of_in_v_cons_cons_lock, AcquireGreaterEqual, 2)
      %c0_97 = arith.constant 0 : index
      %c512_98 = arith.constant 512 : index
      %c1_99 = arith.constant 1 : index
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb8
      ...
      cf.cond_br %1, ^bb2, ^bb9
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_w_cons_cons_lock, AcquireGreaterEqual, 2)
      %c0_0 = arith.constant 0 : index
      %c512 = arith.constant 512 : index
      %c1_1 = arith.constant 1 : index
      cf.br ^bb3(%c0_0 : index)
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_in_n_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_addW_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      %c0_i32 = arith.constant 0 : i32
      ...
      aie.use_lock(%of_addW_cons_lock, Release, 1)
      aie.use_lock(%of_addW_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32_2 = arith.constant 4608 : i32
      %c0_i32_3 = arith.constant 0 : i32
      ...
      aie.use_lock(%of_addW_cons_lock, Release, 1)
      aie.use_lock(%of_in_n_cons_prod_lock, Release, 1)
      %4 = arith.addi %2, %c1_1 : index
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_w_cons_prod_lock, Release, 2)
      aie.use_lock(%of_in_w_cons_cons_lock, AcquireGreaterEqual, 2)
      %c0_97 = arith.constant 0 : index
      %c512_98 = arith.constant 512 : index
      %c1_99 = arith.constant 1 : index
    ...
    ^bb6:  // pred: ^bb5
      aie.use_lock(%of_addU_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_addV_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_addUV_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      ...
      aie.use_lock(%of_addUV_cons_lock, Release, 1)
      aie.use_lock(%of_addU_prod_lock, Release, 1)
      aie.use_lock(%of_addV_cons_prod_lock, Release, 1)
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%of_addUV_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_addW_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_scaleAddBL_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      ...
      aie.use_lock(%of_scaleAddBL_cons_lock, Release, 1)
      aie.use_lock(%of_addUV_prod_lock, Release, 1)
      aie.use_lock(%of_addW_cons_prod_lock, Release, 1)
      aie.use_lock(%of_addUV_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_addW_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_scaleAddBL_prod_lock, AcquireGreaterEqual, 1)
    ...
    ^bb5(%4: index):  // 2 preds: ^bb4, ^bb6
      ...
      cf.cond_br %5, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      aie.use_lock(%of_scaleAddBL_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_trigFifo_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      func.call @scale_single(%of_scaleAddBL_cons_buff_0, %in0_cons_buff_0, %of_trigFifo_buff_0, %c4608_i32) : (memref<4608xbf16>, memref<2xbf16>, memref<4608xbf16>, i32) -> ()
      aie.use_lock(%of_trigFifo_cons_lock, Release, 1)
      aie.use_lock(%of_scaleAddBL_cons_prod_lock, Release, 1)
    ...
    ^bb12:  // pred: ^bb11
      ...
      aie.use_lock(%of_trigFifo_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32_11 = arith.constant 4608 : i32
      func.call @scale_single(%of_scaleAddBL_cons_buff_0, %in0_cons_buff_1, %of_trigFifo_buff_0, %c4608_i32_11) : (memref<4608xbf16>, memref<2xbf16>, memref<4608xbf16>, i32) -> ()
      aie.use_lock(%of_trigFifo_cons_lock, Release, 1)
      aie.use_lock(%of_scaleAddBL_cons_prod_lock, Release, 1)
    ...
    ^bb5(%4: index):  // 2 preds: ^bb4, ^bb6
      ...
      cf.cond_br %5, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      aie.use_lock(%of_trigFifo_0_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_multTrigR_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      func.call @cosine(%of_trigFifo_0_cons_buff_0, %of_multTrigR_buff_0, %c4608_i32) : (memref<4608xbf16>, memref<4608xbf16>, i32) -> ()
      aie.use_lock(%of_multTrigR_cons_lock, Release, 1)
      aie.use_lock(%of_trigFifo_0_cons_prod_lock, Release, 1)
      %6 = arith.addi %4, %c1_3 : index
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %7 = arith.addi %2, %c1_1 : index
    ...
    ^bb5(%4: index):  // 2 preds: ^bb4, ^bb6
      ...
      cf.cond_br %5, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      aie.use_lock(%of_trigFifo_1_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_multTrigC_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      func.call @sine(%of_trigFifo_1_cons_buff_0, %of_multTrigC_buff_0, %c4608_i32) : (memref<4608xbf16>, memref<4608xbf16>, i32) -> ()
      aie.use_lock(%of_multTrigC_cons_lock, Release, 1)
      aie.use_lock(%of_trigFifo_1_cons_prod_lock, Release, 1)
      %6 = arith.addi %4, %c1_3 : index
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %7 = arith.addi %2, %c1_1 : index
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb8
      ...
      cf.cond_br %1, ^bb2, ^bb9
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_visR_cons_cons_lock, AcquireGreaterEqual, 2)
      %c0_0 = arith.constant 0 : index
      %c16384 = arith.constant 16384 : index
      %c1_1 = arith.constant 1 : index
    ...
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_multTrigR_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_reduceR_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      ...
      aie.use_lock(%of_reduceR_cons_lock, Release, 1)
      aie.use_lock(%of_multTrigR_prod_lock, Release, 1)
      aie.use_lock(%of_multTrigR_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_reduceR_prod_lock, AcquireGreaterEqual, 1)
      ...
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_visR_cons_prod_lock, Release, 2)
      aie.use_lock(%of_in_visR_cons_cons_lock, AcquireGreaterEqual, 2)
    ...
    ^bb1(%0: index):  // 2 preds: ^bb0, ^bb8
      ...
      cf.cond_br %1, ^bb2, ^bb9
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_visC_cons_cons_lock, AcquireGreaterEqual, 2)
      %c0_0 = arith.constant 0 : index
      %c16384 = arith.constant 16384 : index
      %c1_1 = arith.constant 1 : index
      %c2_2 = arith.constant 2 : index
    ...
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_multTrigC_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_reduceC_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      ...
      aie.use_lock(%of_reduceC_cons_lock, Release, 1)
      aie.use_lock(%of_multTrigC_prod_lock, Release, 1)
      aie.use_lock(%of_multTrigC_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_reduceC_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32_3 = arith.constant 4608 : i32
      ...
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      aie.use_lock(%of_in_visC_cons_prod_lock, Release, 2)
      aie.use_lock(%of_in_visC_cons_cons_lock, AcquireGreaterEqual, 2)
      %c0_6 = arith.constant 0 : index
      %c16384_7 = arith.constant 16384 : index
      %c1_8 = arith.constant 1 : index
    ...
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_reduceR_cons_lock, AcquireGreaterEqual, 2)
      aie.use_lock(%of_reduc2SubR_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      ...
      aie.use_lock(%of_reduc2SubR_cons_lock, Release, 1)
      aie.use_lock(%of_reduceR_prod_lock, Release, 2)
      aie.use_lock(%of_reduceR_cons_lock, AcquireGreaterEqual, 2)
      aie.use_lock(%of_reduc2SubR_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32_2 = arith.constant 4608 : i32
    ...
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_reduceC_cons_lock, AcquireGreaterEqual, 2)
      aie.use_lock(%of_reduc2SubC_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32 = arith.constant 4608 : i32
      ...
      aie.use_lock(%of_reduc2SubC_cons_lock, Release, 1)
      aie.use_lock(%of_reduceC_prod_lock, Release, 2)
      aie.use_lock(%of_reduceC_cons_lock, AcquireGreaterEqual, 2)
      aie.use_lock(%of_reduc2SubC_prod_lock, AcquireGreaterEqual, 1)
      %c4608_i32_2 = arith.constant 4608 : i32
    ...
    ^bb3(%2: index):  // 2 preds: ^bb2, ^bb4
      ...
      cf.cond_br %3, ^bb4, ^bb5
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_reduc2SubR_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_reduc2SubC_cons_lock, AcquireGreaterEqual, 1)
      ...
      aie.use_lock(%of_reduc2SubR_cons_prod_lock, Release, 1)
      aie.use_lock(%of_reduc2SubC_prod_lock, Release, 1)
      %4 = arith.addi %2, %c1_1 : index
      cf.br ^bb3(%4 : index)
    ^bb5:  // pred: ^bb3
      %5 = arith.addi %0, %c1 : index
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      aie.use_lock(%of_scaleAddBL_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_scaleAddBL_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_scaleAddBL_cons_cons_lock, Release, 1)
      aie.next_bd ^bb4
    ^bb5:  // pred: ^bb3
      %2 = aie.dma_start(MM2S, 0, ^bb6, ^bb7)
    ^bb6:  // 2 preds: ^bb5, ^bb6
      aie.use_lock(%of_trigFifo_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_trigFifo_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 3 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%of_trigFifo_prod_lock, Release, 1)
      aie.next_bd ^bb6
    ^bb7:  // pred: ^bb5
      aie.end
    }
    ...
    %memtile_dma_1_1 = aie.memtile_dma(%mem_tile_1_1) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb2
      aie.use_lock(%in1_cons_prod_lock, AcquireGreaterEqual, 3)
      aie.dma_bd(%in1_cons_buff_0 : memref<13824xbf16>, 0, 13824) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%in1_cons_cons_lock, Release, 3)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%in1_cons_prod_lock, AcquireGreaterEqual, 3)
      aie.dma_bd(%in1_cons_buff_1 : memref<13824xbf16>, 0, 13824) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%in1_cons_cons_lock, Release, 3)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%in1_cons_buff_0 : memref<13824xbf16>, 0, 4608) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_1 : memref<13824xbf16>, 0, 4608) {bd_id = 3 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
    ...
    ^bb10:  // 2 preds: ^bb9, ^bb11
      aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_0 : memref<13824xbf16>, 9216, 4608) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.next_bd ^bb11
    ^bb11:  // pred: ^bb10
      aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%in1_cons_buff_1 : memref<13824xbf16>, 9216, 4608) {bd_id = 5 : i32, next_bd_id = 4 : i32}
      aie.use_lock(%in1_cons_prod_lock, Release, 1)
      aie.next_bd ^bb10
    ^bb12:  // pred: ^bb9
      aie.end
    ...
    %memtile_dma_2_1 = aie.memtile_dma(%mem_tile_2_1) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb2
      aie.use_lock(%in2_cons_prod_lock, AcquireGreaterEqual, 2)
      aie.dma_bd(%in2_cons_buff_0 : memref<9216xbf16>, 0, 9216) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%in2_cons_cons_lock, Release, 2)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%in2_cons_prod_lock, AcquireGreaterEqual, 2)
      aie.dma_bd(%in2_cons_buff_1 : memref<9216xbf16>, 0, 9216) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%in2_cons_cons_lock, Release, 2)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(MM2S, 0, ^bb4, ^bb6)
    ^bb4:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%in2_cons_buff_0 : memref<9216xbf16>, 0, 4608) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%in2_cons_prod_lock, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%in2_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%in2_cons_buff_1 : memref<9216xbf16>, 0, 4608) {bd_id = 3 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%in2_cons_prod_lock, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
      %2 = aie.dma_start(MM2S, 1, ^bb7, ^bb9)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%in3_cons_buff_0 : memref<96xbf16>, 0, 96) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%in3_cons_cons_lock, Release, 3)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%in3_cons_prod_lock, AcquireGreaterEqual, 3)
      aie.dma_bd(%in3_cons_buff_1 : memref<96xbf16>, 0, 96) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%in3_cons_cons_lock, Release, 3)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(MM2S, 0, ^bb4, ^bb6)
    ^bb4:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%in3_cons_buff_0 : memref<96xbf16>, 0, 32) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%in3_cons_prod_lock, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%in3_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%in3_cons_buff_1 : memref<96xbf16>, 0, 32) {bd_id = 3 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%in3_cons_prod_lock, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
      %2 = aie.dma_start(MM2S, 1, ^bb7, ^bb9)
    ^bb7:  // 2 preds: ^bb6, ^bb8
      aie.use_lock(%in3_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%in3_cons_buff_0 : memref<96xbf16>, 32, 32) {bd_id = 24 : i32, next_bd_id = 25 : i32}
      aie.use_lock(%in3_cons_prod_lock, Release, 1)
      aie.next_bd ^bb8
    ^bb8:  // pred: ^bb7
      aie.use_lock(%in3_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%in3_cons_buff_1 : memref<96xbf16>, 32, 32) {bd_id = 25 : i32, next_bd_id = 24 : i32}
      aie.use_lock(%in3_cons_prod_lock, Release, 1)
      aie.next_bd ^bb7
    ^bb9:  // pred: ^bb6
      %3 = aie.dma_start(MM2S, 2, ^bb10, ^bb12)
    ^bb10:  // 2 preds: ^bb9, ^bb11
      aie.use_lock(%in3_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%in3_cons_buff_0 : memref<96xbf16>, 64, 32) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%in3_cons_prod_lock, Release, 1)
      aie.next_bd ^bb11
    ^bb11:  // pred: ^bb10
      aie.use_lock(%in3_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%in3_cons_buff_1 : memref<96xbf16>, 64, 32) {bd_id = 5 : i32, next_bd_id = 4 : i32}
      aie.use_lock(%in3_cons_prod_lock, Release, 1)
      aie.next_bd ^bb10
    ^bb12:  // pred: ^bb9
      aie.end
    ...
    %mem_0_5 = aie.mem(%tile_0_5) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb2
      aie.use_lock(%of_in_u_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_u_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_in_u_cons_cons_lock, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_u_cons_prod_lock, AcquireGreaterEqual, 1)
    ...
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb5)
    ^bb4:  // 2 preds: ^bb3, ^bb4
      aie.use_lock(%of_in_l_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_l_cons_buff_0 : memref<32xbf16>, 0, 32) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_in_l_cons_cons_lock, Release, 1)
      aie.next_bd ^bb4
    ^bb5:  // pred: ^bb3
      aie.end
    }
    %mem_0_4 = aie.mem(%tile_0_4) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb2
      aie.use_lock(%of_in_v_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_v_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_in_v_cons_cons_lock, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_v_cons_prod_lock, AcquireGreaterEqual, 1)
    ...
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb5)
    ^bb4:  // 2 preds: ^bb3, ^bb4
      aie.use_lock(%of_in_m_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_m_cons_buff_0 : memref<32xbf16>, 0, 32) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_in_m_cons_cons_lock, Release, 1)
      aie.next_bd ^bb4
    ^bb5:  // pred: ^bb3
      %2 = aie.dma_start(MM2S, 0, ^bb6, ^bb7)
    ^bb6:  // 2 preds: ^bb5, ^bb6
      aie.use_lock(%of_addV_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_addV_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 3 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%of_addV_prod_lock, Release, 1)
      aie.next_bd ^bb6
    ^bb7:  // pred: ^bb5
      aie.end
    }
    %mem_0_3 = aie.mem(%tile_0_3) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb2
      aie.use_lock(%of_in_w_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_w_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_in_w_cons_cons_lock, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_w_cons_prod_lock, AcquireGreaterEqual, 1)
    ...
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb5)
    ^bb4:  // 2 preds: ^bb3, ^bb4
      aie.use_lock(%of_in_n_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_n_cons_buff_0 : memref<32xbf16>, 0, 32) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_in_n_cons_cons_lock, Release, 1)
      aie.next_bd ^bb4
    ^bb5:  // pred: ^bb3
      %2 = aie.dma_start(MM2S, 0, ^bb6, ^bb7)
    ^bb6:  // 2 preds: ^bb5, ^bb6
      aie.use_lock(%of_addW_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_addW_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 3 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%of_addW_prod_lock, Release, 1)
      aie.next_bd ^bb6
    ^bb7:  // pred: ^bb5
      aie.end
    }
    %mem_2_4 = aie.mem(%tile_2_4) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb2
      aie.use_lock(%of_in_visR_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_visR_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_in_visR_cons_cons_lock, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_visR_cons_prod_lock, AcquireGreaterEqual, 1)
    ...
    %mem_3_4 = aie.mem(%tile_3_4) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb2
      aie.use_lock(%of_in_visC_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_in_visC_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_in_visC_cons_cons_lock, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_in_visC_cons_prod_lock, AcquireGreaterEqual, 1)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_addV_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_addV_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_addV_cons_cons_lock, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      aie.end
    }
    %mem_1_4 = aie.mem(%tile_1_4) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb2
      aie.use_lock(%of_addW_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_addW_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%of_addW_cons_cons_lock, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%of_addW_cons_prod_lock, AcquireGreaterEqual, 1)
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      aie.use_lock(%of_scaleAddBL_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_scaleAddBL_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 2 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%of_scaleAddBL_prod_lock, Release, 1)
      aie.next_bd ^bb4
    ^bb5:  // pred: ^bb3
      aie.end
    }
    %mem_2_5 = aie.mem(%tile_2_5) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_trigFifo_0_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_trigFifo_0_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_trigFifo_0_cons_cons_lock, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      aie.end
    }
    %mem_3_5 = aie.mem(%tile_3_5) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_trigFifo_1_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_trigFifo_1_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_trigFifo_1_cons_cons_lock, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      aie.end
    }
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_reduc2SubR_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_reduc2SubR_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_reduc2SubR_prod_lock, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      aie.end
    }
    %mem_3_2 = aie.mem(%tile_3_2) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%of_reduc2SubR_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%of_reduc2SubR_cons_buff_0 : memref<4608xbf16>, 0, 4608) {bd_id = 0 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%of_reduc2SubR_cons_cons_lock, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb0
      aie.end
    }
