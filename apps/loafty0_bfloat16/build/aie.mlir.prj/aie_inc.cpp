...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile05_bd0), /* addrA */ 0x8000,  /* len */ 48));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile05_bd2), /* addrA */ 0x0,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile05_bd3), /* addrA */ 0x4000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile05_bd1), /* addrA */ 0xC000,  /* len */ 48));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile04_bd0), /* addrA */ 0x8000,  /* len */ 48));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile04_bd2), /* addrA */ 0x0,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile04_bd3), /* addrA */ 0x4000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile04_bd1), /* addrA */ 0xC000,  /* len */ 48));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd0), /* addrA */ 0x8000,  /* len */ 48));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd2), /* addrA */ 0x0,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd3), /* addrA */ 0x4000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd1), /* addrA */ 0xC000,  /* len */ 48));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile35_bd0), /* addrA */ 0x8000,  /* len */ 48));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile35_bd2), /* addrA */ 0x0,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile35_bd3), /* addrA */ 0x4000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile35_bd1), /* addrA */ 0xC000,  /* len */ 48));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile34_bd0), /* addrA */ 0x8000,  /* len */ 48));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile34_bd2), /* addrA */ 0x0,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile34_bd3), /* addrA */ 0x4000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile34_bd1), /* addrA */ 0xC000,  /* len */ 48));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile33_bd0), /* addrA */ 0x8000,  /* len */ 48));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile33_bd2), /* addrA */ 0x0,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile33_bd3), /* addrA */ 0x4000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile33_bd1), /* addrA */ 0xC000,  /* len */ 48));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile13_bd0), /* addrA */ 0x0,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile13_bd1), /* addrA */ 0x4000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile23_bd0), /* addrA */ 0x0,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile23_bd1), /* addrA */ 0x4000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd0), /* addrA */ 0x0,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd1), /* addrA */ 0x4000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile32_bd0), /* addrA */ 0x0,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile32_bd1), /* addrA */ 0x4000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile22_bd0), XAie_LockInit(1,-1),XAie_LockInit(0,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd0), /* addrA */ 0x400,  /* len */ 16));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile22_bd1), XAie_LockInit(1,-1),XAie_LockInit(0,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd1), /* addrA */ 0x4000,  /* len */ 16));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(2,2), /* ChNum */0, /* dmaDir */ DMA_MM2S, /* BdNum */0, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd0), /* addrA */ 0x80000,  /* len */ 46100));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd2), /* addrA */ 0x80000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd24), /* addrA */ 0x82404,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd4), /* addrA */ 0x84808,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd26), /* addrA */ 0x86C0C,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd6), /* addrA */ 0x89010,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd7), /* addrA */ 0x99010,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd27), /* addrA */ 0x96C0C,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd5), /* addrA */ 0x94808,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd25), /* addrA */ 0x92404,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd3), /* addrA */ 0x90000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile01_bd1), XAie_LockInit(64,-5),XAie_LockInit(65,5)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd1), /* addrA */ 0x90000,  /* len */ 46100));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile31_bd0), XAie_LockInit(64,-5),XAie_LockInit(65,5)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd0), /* addrA */ 0x80000,  /* len */ 46100));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd2), /* addrA */ 0x80000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd24), /* addrA */ 0x82404,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd4), /* addrA */ 0x84808,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd26), /* addrA */ 0x86C0C,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd6), /* addrA */ 0x89010,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd7), /* addrA */ 0x99010,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd27), /* addrA */ 0x96C0C,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd5), /* addrA */ 0x94808,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd25), /* addrA */ 0x92404,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd3), /* addrA */ 0x90000,  /* len */ 9220));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile31_bd1), XAie_LockInit(64,-5),XAie_LockInit(65,5)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd1), /* addrA */ 0x90000,  /* len */ 46100));
...
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,1), XAie_LockInit(0, 10)));
...
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(0, 10)));
...
x = 1;
y = 5;
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 2, WEST, 3));
// Core Stream Switch column 2 row 3
x = 2;
y = 3;
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), WEST, 3, EAST, 3));
...
// buffer of_in_mainA2_cons_buff_0 with unsupported type memref<4610xbf16>;
// buffer of_in_mainA2_cons_buff_1 with unsupported type memref<4610xbf16>;
// buffer in0_0_cons_buff_0 with unsupported type memref<24xbf16>;
// buffer in0_0_cons_buff_1 with unsupported type memref<24xbf16>;
// buffer in2_cons_buff_0 with unsupported type memref<23050xbf16>;
// buffer in2_cons_buff_1 with unsupported type memref<23050xbf16>;
// buffer of_in_mainB2_cons_buff_0 with unsupported type memref<4610xbf16>;
// buffer of_in_mainB2_cons_buff_1 with unsupported type memref<4610xbf16>;
// buffer in0_3_cons_buff_0 with unsupported type memref<24xbf16>;
// buffer in0_3_cons_buff_1 with unsupported type memref<24xbf16>;
// buffer of_in_mainA3_cons_buff_0 with unsupported type memref<4610xbf16>;
// buffer of_in_mainA3_cons_buff_1 with unsupported type memref<4610xbf16>;
// buffer in0_1_cons_buff_0 with unsupported type memref<24xbf16>;
// buffer in0_1_cons_buff_1 with unsupported type memref<24xbf16>;
// buffer of_in_mainB3_cons_buff_0 with unsupported type memref<4610xbf16>;
// buffer of_in_mainB3_cons_buff_1 with unsupported type memref<4610xbf16>;
// buffer in0_4_cons_buff_0 with unsupported type memref<24xbf16>;
// buffer in0_4_cons_buff_1 with unsupported type memref<24xbf16>;
// buffer of_in_mainB0_cons_buff_0 with unsupported type memref<4610xbf16>;
// buffer of_in_mainB0_cons_buff_1 with unsupported type memref<4610xbf16>;
// buffer of_in_mainA4_cons_buff_0 with unsupported type memref<4610xbf16>;
// buffer of_in_mainA4_cons_buff_1 with unsupported type memref<4610xbf16>;
// buffer in0_2_cons_buff_0 with unsupported type memref<24xbf16>;
// buffer in0_2_cons_buff_1 with unsupported type memref<24xbf16>;
// buffer of_in_mainA1_cons_buff_0 with unsupported type memref<4610xbf16>;
// buffer of_in_mainA1_cons_buff_1 with unsupported type memref<4610xbf16>;
// buffer of_in_mainA0_cons_buff_0 with unsupported type memref<4610xbf16>;
// buffer of_in_mainA0_cons_buff_1 with unsupported type memref<4610xbf16>;
// buffer out_buff_0 with unsupported type memref<8xbf16>;
// buffer out_buff_1 with unsupported type memref<8xbf16>;
// buffer sub2mean_buff_0 with unsupported type memref<4608xbf16>;
// buffer sub2mean_buff_1 with unsupported type memref<4608xbf16>;
// buffer in1_cons_buff_0 with unsupported type memref<23050xbf16>;
// buffer in1_cons_buff_1 with unsupported type memref<23050xbf16>;
// buffer of_in_mainB1_cons_buff_0 with unsupported type memref<4610xbf16>;
// buffer of_in_mainB1_cons_buff_1 with unsupported type memref<4610xbf16>;
// buffer of_in_mainB4_cons_buff_0 with unsupported type memref<4610xbf16>;
// buffer of_in_mainB4_cons_buff_1 with unsupported type memref<4610xbf16>;
// buffer in0_5_cons_buff_0 with unsupported type memref<24xbf16>;
// buffer in0_5_cons_buff_1 with unsupported type memref<24xbf16>;
...
int mlir_aie_acquire_sub2mean_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_sub2mean_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_sub2mean_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_sub2mean_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainB4_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainB4_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainB4_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainB4_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainA4_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainA4_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainA4_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainA4_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainB3_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainB3_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainB3_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainB3_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainA3_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainA3_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainA3_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainA3_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainB2_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainB2_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainB2_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainB2_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainA2_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainA2_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainA2_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainA2_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainB1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainB1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainB1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainB1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainA1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainA1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainA1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainA1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainB0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainB0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainB0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainB0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainA0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainA0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_of_in_mainA0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_of_in_mainA0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,3), XAie_LockInit(id,value), timeout);
}
