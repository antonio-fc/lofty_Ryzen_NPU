module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @in0(%shim_noc_tile_1_0, {%tile_0_5, %tile_0_4, %tile_0_3, %tile_3_5, %tile_3_4, %tile_3_3}, 2 : i32) : !aie.objectfifo<memref<6xbf16>> 
    ...
    aie.objectfifo @of_add_w0(%tile_0_3, {%tile_1_4}, 1 : i32) : !aie.objectfifo<memref<4608xbf16>> 
    ...
    aie.objectfifo @of_add_w1(%tile_3_3, {%tile_2_4}, 1 : i32) : !aie.objectfifo<memref<4608xbf16>> 
    ...
    %core_0_5 = aie.core(%tile_0_5) {
      ...
      scf.for %arg0 = %c0 to %c14 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c8192 step %c1_1 {
          %2 = aie.objectfifo.acquire @in0(Consume, 1) : !aie.objectfifosubview<memref<6xbf16>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<6xbf16>> -> memref<6xbf16>
          ...
          aie.objectfifo.release @of_add_u0(Produce, 1)
          %8 = aie.objectfifo.acquire @in0(Consume, 1) : !aie.objectfifosubview<memref<6xbf16>>
          %9 = aie.objectfifo.subview.access %8[0] : !aie.objectfifosubview<memref<6xbf16>> -> memref<6xbf16>
        }
