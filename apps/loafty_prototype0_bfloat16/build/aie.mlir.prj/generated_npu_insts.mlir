module {
  aie.device(npu1_4col) {
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%addA1_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%addB1_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_add_aie_scalar(%addA0_cons_buff_1, %addA1_buff_1, %addB1_buff_1, %c1024_i32) : (memref<1024xbf16>, memref<1024xbf16>, memref<1024xbf16>, i32) -> ()
      aie.use_lock(%addB1_cons_lock, Release, 1)
      aie.use_lock(%addA0_cons_prod_lock, Release, 1)
      aie.use_lock(%addA1_prod_lock, Release, 1)
      %4 = arith.addi %2, %c2 : index
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%addB1_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_scaleC_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_add_aie_scalar(%addB0_cons_buff_1, %addB1_buff_1, %of_scaleC_buff_1, %c1024_i32) : (memref<1024xbf16>, memref<1024xbf16>, memref<1024xbf16>, i32) -> ()
      aie.use_lock(%of_scaleC_cons_lock, Release, 1)
      aie.use_lock(%addB0_cons_prod_lock, Release, 1)
      aie.use_lock(%addB1_prod_lock, Release, 1)
      %4 = arith.addi %2, %c2 : index
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @mean_w(%of_meanF_buff_0, %out_buff_0, %c0_i32, %c0_i32) : (memref<1024xbf16>, memref<2xbf16>, i32, i32) -> ()
    ...
    ^bb5:  // pred: ^bb3
      ...
      aie.use_lock(%out_prod_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_meanF_cons_lock, AcquireGreaterEqual, 1)
      func.call @mean_w(%of_meanF_buff_1, %out_buff_1, %c0_i32, %c0_i32) : (memref<1024xbf16>, memref<2xbf16>, i32, i32) -> ()
    ...
    aiex.runtime_sequence(%arg0: memref<9216xbf16>, %arg1: memref<9216xbf16>, %arg2: memref<9216xbf16>, %arg3: memref<9216xbf16>, %arg4: memref<9216xbf16>) {
      ...
      aiex.npu.blockwrite(%1) {address = 67227712 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 67227716 : ui32, arg_idx = 1 : i32, arg_plus = 0 : i32}
      aiex.npu.write32 {address = 119316 : ui32, column = 2 : i32, row = 0 : i32, value = 2 : ui32}
