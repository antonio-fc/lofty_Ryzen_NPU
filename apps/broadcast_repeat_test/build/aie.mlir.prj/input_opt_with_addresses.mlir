module attributes {llvm.target_triple = "aie2"} {
  ...
  llvm.func @core_1_2() {
    ...
    %14 = llvm.mlir.constant(18 : index) : i64
  ...
  ^bb3:  // pred: ^bb2
    ...
    %22 = llvm.getelementptr %5[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1024 x bf16>
    ...
    %25 = llvm.getelementptr %0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1024 x bf16>
