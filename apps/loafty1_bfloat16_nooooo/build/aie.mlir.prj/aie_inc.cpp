...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd0), /* addrA */ 0x8000,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile22_bd2), XAie_LockInit(3,-1),XAie_LockInit(2,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd2), /* addrA */ 0x400,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile22_bd3), XAie_LockInit(3,-1),XAie_LockInit(2,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd3), /* addrA */ 0x4000,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd1), /* addrA */ 0xC000,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(2,2), /* ChNum */0, /* dmaDir */ DMA_MM2S, /* BdNum */2, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile32_bd0), /* addrA */ 0x8000,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile32_bd2), /* addrA */ 0x400,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile32_bd3), /* addrA */ 0x4000,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile32_bd1), /* addrA */ 0xC000,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd0), /* addrA */ 0x80000,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd26), /* addrA */ 0x81200,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd4), /* addrA */ 0x81800,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd28), /* addrA */ 0x81E00,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd6), /* addrA */ 0x80000,  /* len */ 9216));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd7), /* addrA */ 0x90000,  /* len */ 9216));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd29), /* addrA */ 0x91E00,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd5), /* addrA */ 0x91800,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd27), /* addrA */ 0x91200,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd3), /* addrA */ 0x90C00,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd25), /* addrA */ 0x90600,  /* len */ 1536));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd1), /* addrA */ 0x90000,  /* len */ 1536));
...
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 3, EAST, 1));
...
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), EAST, 1, SOUTH, 1));
...
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), EAST, 3, SOUTH, 3));
...
x = 1;
y = 3;
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), WEST, 1, EAST, 2));
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), WEST, 2, EAST, 1));
...
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 5, DMA, 4));
...
// buffer memC5_buff_0 with unsupported type memref<768xbf16>;
// buffer memC5_buff_1 with unsupported type memref<768xbf16>;
// buffer memA5_cons_buff_0 with unsupported type memref<768xbf16>;
// buffer memA5_cons_buff_1 with unsupported type memref<768xbf16>;
// buffer memC1_buff_0 with unsupported type memref<768xbf16>;
// buffer memC1_buff_1 with unsupported type memref<768xbf16>;
// buffer memA1_cons_buff_0 with unsupported type memref<768xbf16>;
// buffer memA1_cons_buff_1 with unsupported type memref<768xbf16>;
// buffer memC2_buff_0 with unsupported type memref<768xbf16>;
// buffer memC2_buff_1 with unsupported type memref<768xbf16>;
// buffer memA2_cons_buff_0 with unsupported type memref<768xbf16>;
// buffer memA2_cons_buff_1 with unsupported type memref<768xbf16>;
// buffer memC0_buff_0 with unsupported type memref<768xbf16>;
// buffer memC0_buff_1 with unsupported type memref<768xbf16>;
// buffer memA0_cons_buff_0 with unsupported type memref<768xbf16>;
// buffer memA0_cons_buff_1 with unsupported type memref<768xbf16>;
// buffer inA_cons_buff_0 with unsupported type memref<4608xbf16>;
// buffer inA_cons_buff_1 with unsupported type memref<4608xbf16>;
// buffer memC3_buff_0 with unsupported type memref<768xbf16>;
// buffer memC3_buff_1 with unsupported type memref<768xbf16>;
// buffer memA3_cons_buff_0 with unsupported type memref<768xbf16>;
// buffer memA3_cons_buff_1 with unsupported type memref<768xbf16>;
// buffer outC_buff_0 with unsupported type memref<4608xbf16>;
// buffer outC_buff_1 with unsupported type memref<4608xbf16>;
// buffer memC4_buff_0 with unsupported type memref<768xbf16>;
// buffer memC4_buff_1 with unsupported type memref<768xbf16>;
// buffer memA4_cons_buff_0 with unsupported type memref<768xbf16>;
// buffer memA4_cons_buff_1 with unsupported type memref<768xbf16>;
...
int mlir_aie_acquire_memC5_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memC5_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memC5_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memC5_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memC4_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memC4_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memC4_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memC4_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
...
int mlir_aie_acquire_memA5_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memA5_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memA5_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memA5_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memA4_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memA4_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memA4_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memA4_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
