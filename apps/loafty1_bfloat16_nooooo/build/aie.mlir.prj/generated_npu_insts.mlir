module {
  aie.device(npu1_4col) {
    ...
    aie.flow(%mem_tile_0_1, DMA : 1, %tile_2_3, DMA : 0)
    aie.flow(%mem_tile_0_1, DMA : 2, %tile_2_4, DMA : 0)
    aie.flow(%mem_tile_0_1, DMA : 3, %tile_3_2, DMA : 0)
    aie.flow(%mem_tile_0_1, DMA : 4, %tile_3_3, DMA : 0)
    aie.flow(%mem_tile_0_1, DMA : 5, %tile_3_4, DMA : 0)
    aie.flow(%tile_2_2, DMA : 0, %mem_tile_1_1, DMA : 0)
    aie.flow(%tile_2_3, DMA : 0, %mem_tile_1_1, DMA : 1)
    aie.flow(%tile_2_4, DMA : 0, %mem_tile_1_1, DMA : 2)
    aie.flow(%tile_3_2, DMA : 0, %mem_tile_1_1, DMA : 3)
    aie.flow(%tile_3_3, DMA : 0, %mem_tile_1_1, DMA : 4)
    aie.flow(%tile_3_4, DMA : 0, %mem_tile_1_1, DMA : 5)
    ...
    ^bb12(%15: index):  // 2 preds: ^bb11, ^bb13
      %16 = arith.cmpi slt, %15, %c768 : index
    ...
    ^bb17(%23: index):  // 2 preds: ^bb16, ^bb18
      %24 = arith.cmpi slt, %23, %c768 : index
    ...
    ^bb20(%27: index):  // 2 preds: ^bb19, ^bb21
      %28 = arith.cmpi slt, %27, %c768 : index
    ...
    ^bb24(%34: index):  // 2 preds: ^bb23, ^bb25
      %35 = arith.cmpi slt, %34, %c768 : index
    ...
    ^bb30(%43: index):  // 2 preds: ^bb29, ^bb31
      %44 = arith.cmpi slt, %43, %c768 : index
    ...
    ^bb33(%47: index):  // 2 preds: ^bb32, ^bb34
      %48 = arith.cmpi slt, %47, %c768 : index
    ...
    ^bb37(%54: index):  // 2 preds: ^bb36, ^bb38
      %55 = arith.cmpi slt, %54, %c768 : index
    ...
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[11520, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    aiex.runtime_sequence(%arg0: memref<23040xbf16>, %arg1: memref<23040xbf16>, %arg2: memref<23040xbf16>) {
      ...
      aiex.npu.blockwrite(%1) {address = 33673216 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 33673220 : ui32, arg_idx = 2 : i32, arg_plus = 0 : i32}
