...
7:                                                ; preds = %4
  ...
  call void @vector_mult_aie_scalar(ptr @of_multE_buff_0, ptr @in1_cons_buff_0, ptr @out_buff_0, i32 1024)
  ...
  call void @vector_mult_aie_scalar(ptr @of_multE_buff_1, ptr @in1_cons_buff_1, ptr @out_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 53, i32 1)
  call void @llvm.aie2.release(i32 16, i32 1)
  call void @llvm.aie2.release(i32 48, i32 1)
  %8 = add i64 %5, 2
...
7:                                                ; preds = %4
  ...
  call void @cos_float_1024(ptr @of_cosD_buff_0, ptr @of_multE_buff_0, i32 1024)
  ...
  call void @cos_float_1024(ptr @of_cosD_buff_1, ptr @of_multE_buff_1, i32 1024)
  call void @llvm.aie2.release(i32 49, i32 1)
  call void @llvm.aie2.release(i32 4, i32 1)
  %8 = add i64 %5, 2
  br label %4
