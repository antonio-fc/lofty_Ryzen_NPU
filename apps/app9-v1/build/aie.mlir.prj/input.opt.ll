; ModuleID = '/notebooks/my_mlir-aie/apps/app9-v1/build/aie.mlir.prj/input.ll'
...
.preheader3:                                      ; preds = %0, %.preheader3
  ...
  tail call void @vector_mult_aie_scalar(ptr nonnull @of_multE_buff_0, ptr nonnull @in1_cons_buff_0, ptr nonnull @out_buff_0, i32 1024)
  ...
  tail call void @vector_mult_aie_scalar(ptr nonnull @of_multE_buff_1, ptr nonnull @in1_cons_buff_1, ptr nonnull @out_buff_1, i32 1024)
  tail call void @llvm.aie2.release(i32 53, i32 1)
  tail call void @llvm.aie2.release(i32 16, i32 1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.acquire(i32 17, i32 -1)
