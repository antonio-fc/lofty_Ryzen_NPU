module attributes {llvm.target_triple = "aie2"} {
  ...
  llvm.mlir.global external @in1_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<9216 x bf16>
  llvm.mlir.global external @in1_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<9216 x bf16>
  llvm.mlir.global external @in2_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<13824 x bf16>
  llvm.mlir.global external @in2_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<13824 x bf16>
  ...
  llvm.mlir.global external @visR_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<4608 x bf16>
  llvm.mlir.global external @visR_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<4608 x bf16>
  llvm.mlir.global external @visC_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<4608 x bf16>
  llvm.mlir.global external @visC_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<4608 x bf16>
  ...
  llvm.mlir.global external @visC_cons() {addr_space = 0 : i32} : !llvm.array<4608 x bf16>
  llvm.mlir.global external @visC() {addr_space = 0 : i32} : !llvm.array<4608 x bf16>
  llvm.mlir.global external @visR_cons() {addr_space = 0 : i32} : !llvm.array<4608 x bf16>
  llvm.mlir.global external @visR() {addr_space = 0 : i32} : !llvm.array<4608 x bf16>
  ...
  llvm.mlir.global external @in2_cons() {addr_space = 0 : i32} : !llvm.array<13824 x bf16>
  llvm.mlir.global external @in2() {addr_space = 0 : i32} : !llvm.array<13824 x bf16>
  llvm.mlir.global external @in1_cons() {addr_space = 0 : i32} : !llvm.array<9216 x bf16>
  llvm.mlir.global external @in1() {addr_space = 0 : i32} : !llvm.array<9216 x bf16>
