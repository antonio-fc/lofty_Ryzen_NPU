...
void cosine(bfloat16 *in, bfloat16 *out, uint32_t N) {
    ...
    chess_prepare_for_pipelining chess_loop_range(64, 64) {
        for (int i = 0; i < N; i += vsize) {
            ...
            // v64 version
            // auto input = aie::load_v<vsize>(in + i);
            ...
            auto input2 = input.extract<32>(2);
            auto input3 = input.extract<32>(3);
            auto input4 = input.extract<32>(4);
            auto input5 = input.extract<32>(5);
            auto input6 = input.extract<32>(6);
            auto input7 = input.extract<32>(7);
            auto result0 = cos_bfloat16(input0);
            auto result1 = cos_bfloat16(input1);
            auto result2 = cos_bfloat16(input2);
            auto result3 = cos_bfloat16(input3);
            auto result4 = cos_bfloat16(input4);
            auto result5 = cos_bfloat16(input5);
            auto result6 = cos_bfloat16(input6);
            auto result7 = cos_bfloat16(input7);
            auto result = aie::concat(aie::concat(aie::concat(result0, result1), aie::concat(result2, result3)), aie::concat(aie::concat(result4, result5), aie::concat(result6, result7)));
...
void sine(bfloat16 *in, bfloat16 *out, uint32_t N) {
    ...
    chess_prepare_for_pipelining chess_loop_range(64, 64) {
        for (int i = 0; i < N; i += vsize) {
            ...
            auto result2 = sin_bfloat16(input2);
            auto result3 = sin_bfloat16(input3);
            auto result4 = sin_bfloat16(input4);
            auto result5 = sin_bfloat16(input5);
            auto result6 = sin_bfloat16(input6);
            auto result7 = sin_bfloat16(input7);
            auto result = aie::concat(aie::concat(aie::concat(result0, result1), aie::concat(result2, result3)), aie::concat(aie::concat(result4, result5), aie::concat(result6, result7)));
