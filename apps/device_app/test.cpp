...
int main(int argc, const char *argv[]) {
    ...
    DATATYPE default_value = (DATATYPE) 1.0f;
    
    vector<DATATYPE> visR(MSIZE, default_value); // real component of visibilities
    vector<DATATYPE> visI(MSIZE, default_value); // imaginary component of visibilities
    
    vector<DATATYPE> u(MSIZE, default_value); // baselines, u
    vector<DATATYPE> v(MSIZE, default_value); // baselines, v
    vector<DATATYPE> w(MSIZE, default_value); // baselines, w
