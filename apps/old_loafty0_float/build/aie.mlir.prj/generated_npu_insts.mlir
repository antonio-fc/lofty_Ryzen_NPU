module {
  aie.device(npu1_4col) {
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%u_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%addB0_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_scale(%u_cons_buff_1, %addB0_buff_1, %l_cons_buff_0, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
      aie.use_lock(%addB0_cons_lock, Release, 1)
      aie.use_lock(%u_cons_prod_lock, Release, 1)
    ...
    ^bb7:  // pred: ^bb6
      aie.use_lock(%u_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%addB0_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_scale(%u_cons_buff_1, %addB0_buff_1, %l_cons_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
      aie.use_lock(%addB0_cons_lock, Release, 1)
      aie.use_lock(%u_cons_prod_lock, Release, 1)
      aie.use_lock(%u_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%addB0_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_scale(%u_cons_buff_0, %addB0_buff_0, %l_cons_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
      aie.use_lock(%addB0_cons_lock, Release, 1)
      aie.use_lock(%u_cons_prod_lock, Release, 1)
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%v_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%addA0_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_scale(%v_cons_buff_1, %addA0_buff_1, %m_cons_buff_0, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
      aie.use_lock(%addA0_cons_lock, Release, 1)
      aie.use_lock(%v_cons_prod_lock, Release, 1)
      %4 = arith.addi %2, %c2 : index
      cf.br ^bb3(%4 : index)
    ...
    ^bb7:  // pred: ^bb6
      aie.use_lock(%v_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%addA0_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_scale(%v_cons_buff_1, %addA0_buff_1, %m_cons_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
      aie.use_lock(%addA0_cons_lock, Release, 1)
      aie.use_lock(%v_cons_prod_lock, Release, 1)
      aie.use_lock(%v_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%addA0_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_scale(%v_cons_buff_0, %addA0_buff_0, %m_cons_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
      aie.use_lock(%addA0_cons_lock, Release, 1)
      aie.use_lock(%v_cons_prod_lock, Release, 1)
      %7 = arith.addi %5, %c2 : index
      cf.br ^bb6(%7 : index)
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%w_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%addA1_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_scale(%w_cons_buff_1, %addA1_buff_1, %n_cons_buff_0, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
      aie.use_lock(%addA1_cons_lock, Release, 1)
      aie.use_lock(%w_cons_prod_lock, Release, 1)
      %4 = arith.addi %2, %c2 : index
      cf.br ^bb3(%4 : index)
    ...
    ^bb7:  // pred: ^bb6
      aie.use_lock(%w_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%addA1_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_scale(%w_cons_buff_1, %addA1_buff_1, %n_cons_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
      aie.use_lock(%addA1_cons_lock, Release, 1)
      aie.use_lock(%w_cons_prod_lock, Release, 1)
      aie.use_lock(%w_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%addA1_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_scale(%w_cons_buff_0, %addA1_buff_0, %n_cons_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
      aie.use_lock(%addA1_cons_lock, Release, 1)
      aie.use_lock(%w_cons_prod_lock, Release, 1)
      %7 = arith.addi %5, %c2 : index
      cf.br ^bb6(%7 : index)
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%addA1_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%addB1_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_add(%addA0_cons_buff_1, %addA1_buff_1, %addB1_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1024xf32>, i32) -> ()
      aie.use_lock(%addB1_cons_lock, Release, 1)
      aie.use_lock(%addA0_cons_prod_lock, Release, 1)
      aie.use_lock(%addA1_prod_lock, Release, 1)
      %4 = arith.addi %2, %c2 : index
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%addB1_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_scaleC_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_add(%addB0_cons_buff_1, %addB1_buff_1, %of_scaleC_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1024xf32>, i32) -> ()
      aie.use_lock(%of_scaleC_cons_lock, Release, 1)
      aie.use_lock(%addB0_cons_prod_lock, Release, 1)
      aie.use_lock(%addB1_prod_lock, Release, 1)
      %4 = arith.addi %2, %c2 : index
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%of_scaleC_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_sincosD_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_scale(%of_scaleC_buff_1, %of_sincosD_buff_1, %in0_cons_buff_0, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
      aie.use_lock(%of_sincosD_cons_lock, Release, 1)
      aie.use_lock(%of_scaleC_prod_lock, Release, 1)
      %4 = arith.addi %2, %c2 : index
      cf.br ^bb3(%4 : index)
    ...
    ^bb7:  // pred: ^bb6
      aie.use_lock(%of_scaleC_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_sincosD_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_scale(%of_scaleC_buff_1, %of_sincosD_buff_1, %in0_cons_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
      aie.use_lock(%of_sincosD_cons_lock, Release, 1)
      aie.use_lock(%of_scaleC_prod_lock, Release, 1)
      aie.use_lock(%of_scaleC_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_sincosD_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_scale(%of_scaleC_buff_0, %of_sincosD_buff_0, %in0_cons_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
      aie.use_lock(%of_sincosD_cons_lock, Release, 1)
      aie.use_lock(%of_scaleC_prod_lock, Release, 1)
      %7 = arith.addi %5, %c2 : index
      cf.br ^bb6(%7 : index)
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%of_sincosD_1_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_multEc_prod_lock, AcquireGreaterEqual, 1)
      func.call @sin_float_1024(%of_sincosD_1_cons_buff_1, %of_multEc_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, i32) -> ()
      aie.use_lock(%of_multEc_cons_lock, Release, 1)
      aie.use_lock(%of_sincosD_1_cons_prod_lock, Release, 1)
      %4 = arith.addi %2, %c2 : index
      cf.br ^bb3(%4 : index)
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%of_sincosD_0_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_multEr_prod_lock, AcquireGreaterEqual, 1)
      func.call @cos_float_1024(%of_sincosD_0_cons_buff_1, %of_multEr_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, i32) -> ()
      aie.use_lock(%of_multEr_cons_lock, Release, 1)
      aie.use_lock(%of_sincosD_0_cons_prod_lock, Release, 1)
      %4 = arith.addi %2, %c2 : index
      cf.br ^bb3(%4 : index)
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%visC_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_subFc_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_mult(%of_multEc_buff_1, %visC_cons_buff_1, %of_subFc_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1024xf32>, i32) -> ()
      aie.use_lock(%of_subFc_cons_lock, Release, 1)
      aie.use_lock(%of_multEc_prod_lock, Release, 1)
      aie.use_lock(%visC_cons_prod_lock, Release, 1)
      %4 = arith.addi %2, %c2 : index
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%visR_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_subFr_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_mult(%of_multEr_buff_1, %visR_cons_buff_1, %of_subFr_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1024xf32>, i32) -> ()
      aie.use_lock(%of_subFr_cons_lock, Release, 1)
      aie.use_lock(%of_multEr_prod_lock, Release, 1)
      aie.use_lock(%visR_cons_prod_lock, Release, 1)
      %4 = arith.addi %2, %c2 : index
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.use_lock(%of_subFc_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_mean_prod_lock, AcquireGreaterEqual, 1)
      func.call @vector_sub(%of_subFr_buff_1, %of_subFc_cons_buff_1, %of_mean_buff_1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1024xf32>, i32) -> ()
      aie.use_lock(%of_mean_cons_lock, Release, 1)
      aie.use_lock(%of_subFr_prod_lock, Release, 1)
      aie.use_lock(%of_subFc_cons_prod_lock, Release, 1)
      %4 = arith.addi %2, %c2 : index
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @mean(%of_mean_buff_0, %out_buff_0, %c0_i32, %c0_i32) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
    ...
    ^bb4:  // pred: ^bb3
      aie.use_lock(%of_mean_cons_lock, AcquireGreaterEqual, 1)
      func.call @mean(%of_mean_buff_1, %out_buff_0, %c1024_i32, %c1_i32) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
      aie.use_lock(%of_mean_prod_lock, Release, 1)
      aie.use_lock(%of_mean_cons_lock, AcquireGreaterEqual, 1)
      func.call @mean(%of_mean_buff_0, %out_buff_0, %c1024_i32, %c1_i32) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
      aie.use_lock(%of_mean_prod_lock, Release, 1)
    ...
    ^bb5:  // pred: ^bb3
      ...
      aie.use_lock(%out_prod_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%of_mean_cons_lock, AcquireGreaterEqual, 1)
      func.call @mean(%of_mean_buff_1, %out_buff_1, %c0_i32, %c0_i32) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
      func.call @mean(%of_mean_buff_1, %out_buff_1, %c1024_i32, %c1_i32) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
      aie.use_lock(%of_mean_prod_lock, Release, 1)
      cf.br ^bb6(%c2 : index)
    ^bb6(%5: index):  // 2 preds: ^bb5, ^bb7
      %6 = arith.cmpi slt, %5, %c8 : index
    ...
    ^bb7:  // pred: ^bb6
      aie.use_lock(%of_mean_cons_lock, AcquireGreaterEqual, 1)
      func.call @mean(%of_mean_buff_0, %out_buff_1, %c1024_i32, %c1_i32) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
      aie.use_lock(%of_mean_prod_lock, Release, 1)
      aie.use_lock(%of_mean_cons_lock, AcquireGreaterEqual, 1)
      func.call @mean(%of_mean_buff_1, %out_buff_1, %c1024_i32, %c1_i32) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
      aie.use_lock(%of_mean_prod_lock, Release, 1)
    ...
    ^bb8:  // pred: ^bb6
      ...
      aie.use_lock(%of_mean_cons_lock, AcquireGreaterEqual, 1)
      func.call @mean(%of_mean_buff_1, %out_buff_1, %c1024_i32, %c1_i32) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
      func.call @mean(%of_mean_buff_1, %out_buff_1, %c9216_i32, %c2_i32) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
      aie.use_lock(%of_mean_prod_lock, Release, 1)
      aie.use_lock(%out_cons_lock, Release, 1)
      %8 = arith.addi %0, %c2 : index
      cf.br ^bb1(%8 : index)
    ...
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[18432, 0, 0, 0, -2147483648, 0, 0, 33554432]>
