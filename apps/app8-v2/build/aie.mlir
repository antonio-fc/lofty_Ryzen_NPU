module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @of_meanG(%tile_2_4, {%tile_3_4}, 10 : i32) : !aie.objectfifo<memref<2xbf16>> 
    aie.objectfifo @out(%tile_3_4, {%tile_3_0}, 2 : i32) : !aie.objectfifo<memref<2xbf16>> 
    ...
    %core_2_4 = aie.core(%tile_2_4) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          %0 = aie.objectfifo.acquire @of_meanF(Consume, 1) : !aie.objectfifosubview<memref<1024xbf16>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1024xbf16>> -> memref<1024xbf16>
          %2 = aie.objectfifo.acquire @of_meanG(Produce, 1) : !aie.objectfifosubview<memref<2xbf16>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<2xbf16>> -> memref<2xbf16>
          %c1024_i16 = arith.constant 1024 : i16
          func.call @mean(%1, %3, %c1024_i16) : (memref<1024xbf16>, memref<2xbf16>, i16) -> ()
    ...
    %core_3_4 = aie.core(%tile_3_4) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<2xbf16>> -> memref<2xbf16>
        %2 = aie.objectfifo.acquire @of_meanG(Consume, 1) : !aie.objectfifosubview<memref<2xbf16>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<2xbf16>> -> memref<2xbf16>
        %c0_0 = arith.constant 0 : index
        %4 = memref.load %3[%c0_0] : memref<2xbf16>
        %c0_1 = arith.constant 0 : index
        memref.store %4, %1[%c0_1] : memref<2xbf16>
        aie.objectfifo.release @of_meanG(Consume, 1)
        %c1_2 = arith.constant 1 : index
        %c9 = arith.constant 9 : index
        %c1_3 = arith.constant 1 : index
        scf.for %arg1 = %c1_2 to %c9 step %c1_3 {
          %7 = aie.objectfifo.acquire @of_meanG(Consume, 1) : !aie.objectfifosubview<memref<2xbf16>>
          %8 = aie.objectfifo.subview.access %7[0] : !aie.objectfifosubview<memref<2xbf16>> -> memref<2xbf16>
          %c0_6 = arith.constant 0 : index
          %9 = memref.load %1[%c0_6] : memref<2xbf16>
          %c0_7 = arith.constant 0 : index
          %10 = memref.load %8[%c0_7] : memref<2xbf16>
          %11 = arith.addf %9, %10 : bf16
          %c0_8 = arith.constant 0 : index
          memref.store %11, %1[%c0_8] : memref<2xbf16>
          aie.objectfifo.release @of_meanG(Consume, 1)
        }
        %c0_4 = arith.constant 0 : index
        %5 = memref.load %1[%c0_4] : memref<2xbf16>
        %cst = arith.constant 9.000000e+00 : bf16
        %6 = arith.divf %5, %cst : bf16
        %c1_5 = arith.constant 1 : index
        memref.store %6, %1[%c1_5] : memref<2xbf16>
