module {
  aie.device(npu1_1col) {
    ...
    ^bb4:  // pred: ^bb3
      ...
      func.call @passthrough(%in_cons_buff_0, %out_buff_0, %c1024_i32) : (memref<1024xi32>, memref<1024xi32>, i32) -> ()
      aie.use_lock(%in_cons_prod_lock, Release, 1)
      aie.use_lock(%out_cons_lock, Release, 1)
      aie.use_lock(%out_prod_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%in_cons_cons_lock, AcquireGreaterEqual, 1)
      %c1024_i32_2 = arith.constant 1024 : i32
      func.call @passthrough(%in_cons_buff_1, %out_buff_1, %c1024_i32_2) : (memref<1024xi32>, memref<1024xi32>, i32) -> ()
      aie.use_lock(%in_cons_prod_lock, Release, 1)
      aie.use_lock(%out_cons_lock, Release, 1)
