...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile14_bd0), /* addrA */ 0x8000,  /* len */ 4096));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile14_bd1), /* addrA */ 0xC000,  /* len */ 4096));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile34_bd0), XAie_LockInit(1,-1),XAie_LockInit(0,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile34_bd0), /* addrA */ 0x400,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile34_bd1), XAie_LockInit(1,-1),XAie_LockInit(0,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile34_bd1), /* addrA */ 0x4000,  /* len */ 4));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(3,4), /* ChNum */0, /* dmaDir */ DMA_MM2S, /* BdNum */0, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,4), XAie_LockInit(0, 10)));
...
const int of_meanF_buff_0_offset = 1024;
float mlir_aie_read_buffer_of_meanF_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(1,4), of_meanF_buff_0_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_meanF_buff_0(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(1,4), of_meanF_buff_0_offset + (index*4), int_value);
return rc;
}
const int of_meanF_buff_1_offset = 16384;
float mlir_aie_read_buffer_of_meanF_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(1,4), of_meanF_buff_1_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_meanF_buff_1(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(1,4), of_meanF_buff_1_offset + (index*4), int_value);
return rc;
}
const int in1_cons_buff_0_offset = 32768;
float mlir_aie_read_buffer_in1_cons_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(1,4), in1_cons_buff_0_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_in1_cons_buff_0(aie_libxaie_ctx_t* ctx, int index, float value) {
  ...
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(1,4), in1_cons_buff_0_offset + (index*4), int_value);
return rc;
}
const int in1_cons_buff_1_offset = 49152;
float mlir_aie_read_buffer_in1_cons_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(1,4), in1_cons_buff_1_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_in1_cons_buff_1(aie_libxaie_ctx_t* ctx, int index, float value) {
  ...
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(1,4), in1_cons_buff_1_offset + (index*4), int_value);
return rc;
}
const int of_multE_buff_0_offset = 1024;
float mlir_aie_read_buffer_of_multE_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,4), of_multE_buff_0_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_multE_buff_0(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,4), of_multE_buff_0_offset + (index*4), int_value);
return rc;
}
const int of_multE_buff_1_offset = 16384;
float mlir_aie_read_buffer_of_multE_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,4), of_multE_buff_1_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_multE_buff_1(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,4), of_multE_buff_1_offset + (index*4), int_value);
return rc;
}
const int out_buff_0_offset = 1024;
float mlir_aie_read_buffer_out_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(3,4), out_buff_0_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_out_buff_0(aie_libxaie_ctx_t* ctx, int index, float value) {
  ...
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(3,4), out_buff_0_offset + (index*4), int_value);
return rc;
}
const int out_buff_1_offset = 16384;
float mlir_aie_read_buffer_out_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(3,4), out_buff_1_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_out_buff_1(aie_libxaie_ctx_t* ctx, int index, float value) {
  ...
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(3,4), out_buff_1_offset + (index*4), int_value);
return rc;
}
...
const int of_cosD_buff_0_offset = 1024;
float mlir_aie_read_buffer_of_cosD_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,3), of_cosD_buff_0_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_cosD_buff_0(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,3), of_cosD_buff_0_offset + (index*4), int_value);
return rc;
}
const int of_cosD_buff_1_offset = 16384;
float mlir_aie_read_buffer_of_cosD_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,3), of_cosD_buff_1_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_cosD_buff_1(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,3), of_cosD_buff_1_offset + (index*4), int_value);
return rc;
}
...
const int of_meanG_buff_0_offset = 1024;
float mlir_aie_read_buffer_of_meanG_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_0_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_meanG_buff_0(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_0_offset + (index*4), int_value);
return rc;
}
const int of_meanG_buff_1_offset = 16384;
float mlir_aie_read_buffer_of_meanG_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_1_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_meanG_buff_1(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_1_offset + (index*4), int_value);
return rc;
}
const int of_meanG_buff_2_offset = 32768;
float mlir_aie_read_buffer_of_meanG_buff_2(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_2_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_meanG_buff_2(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_2_offset + (index*4), int_value);
return rc;
}
const int of_meanG_buff_3_offset = 49152;
float mlir_aie_read_buffer_of_meanG_buff_3(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_3_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_meanG_buff_3(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_3_offset + (index*4), int_value);
return rc;
}
const int of_meanG_buff_4_offset = 1028;
float mlir_aie_read_buffer_of_meanG_buff_4(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_4_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_meanG_buff_4(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_4_offset + (index*4), int_value);
return rc;
}
const int of_meanG_buff_5_offset = 16388;
float mlir_aie_read_buffer_of_meanG_buff_5(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_5_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_meanG_buff_5(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_5_offset + (index*4), int_value);
return rc;
}
const int of_meanG_buff_6_offset = 32772;
float mlir_aie_read_buffer_of_meanG_buff_6(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_6_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_meanG_buff_6(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_6_offset + (index*4), int_value);
return rc;
}
const int of_meanG_buff_7_offset = 49156;
float mlir_aie_read_buffer_of_meanG_buff_7(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_7_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_meanG_buff_7(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_7_offset + (index*4), int_value);
return rc;
}
const int of_meanG_buff_8_offset = 1032;
float mlir_aie_read_buffer_of_meanG_buff_8(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_8_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_meanG_buff_8(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_8_offset + (index*4), int_value);
return rc;
}
const int of_meanG_buff_9_offset = 16392;
float mlir_aie_read_buffer_of_meanG_buff_9(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_9_offset + (index*4), &value);
  union caster { int32_t i; float f; };
  caster c; c.i = value;
  return c.f;
}
int mlir_aie_write_buffer_of_meanG_buff_9(aie_libxaie_ctx_t* ctx, int index, float value) {
  union caster { int32_t i; float f; };
  caster c; c.f = value;
  int32_t int_value = c.i;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(2,4), of_meanG_buff_9_offset + (index*4), int_value);
return rc;
}
