module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @in1(%tile_3_0, {%tile_3_1}, 1 : i32) : !aie.objectfifo<memref<2048xf32>> 
    ...
    aie.objectfifo @visR(%tile_3_1, {%tile_3_4}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo @visC(%tile_3_1, {%tile_3_5}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo.link [@in1] -> [@visR, @visC]([] [0, 1024])
    aie.objectfifo @u(%tile_1_1, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo @v(%tile_1_1, {%tile_1_2}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo @w(%tile_1_1, {%tile_2_2}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo.link [@in2] -> [@u, @v, @w]([] [0, 1024, 2048])
    aie.objectfifo @l(%tile_2_1, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<1xf32>> 
    aie.objectfifo @m(%tile_2_1, {%tile_1_2}, 2 : i32) : !aie.objectfifo<memref<1xf32>> 
    aie.objectfifo @n(%tile_2_1, {%tile_2_2}, 2 : i32) : !aie.objectfifo<memref<1xf32>> 
    aie.objectfifo.link [@in3] -> [@l, @m, @n]([] [0, 1, 2])
    aie.objectfifo @addA0(%tile_1_2, {%tile_2_3}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo @addA1(%tile_2_2, {%tile_2_3}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo @addB0(%tile_0_2, {%tile_1_3}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    ...
    aie.objectfifo @of_sincosD(%tile_0_3, {%tile_2_4, %tile_2_5}, 3 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo @of_multEr(%tile_2_4, {%tile_3_4}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo @of_multEc(%tile_2_5, {%tile_3_5}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo @of_subFr(%tile_3_4, {%tile_3_3}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo @of_subFc(%tile_3_5, {%tile_3_3}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo @of_mean(%tile_3_3, {%tile_3_2}, 2 : i32) : !aie.objectfifo<memref<1024xf32>> 
    aie.objectfifo @out(%tile_3_2, {%tile_2_0}, 2 : i32) : !aie.objectfifo<memref<1xf32>> 
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          ...
          func.call @vector_scale(%3, %5, %1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
    ...
    %core_2_3 = aie.core(%tile_2_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          ...
          %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %c1024_i32 = arith.constant 1024 : i32
          func.call @vector_add(%1, %3, %5, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1024xf32>, i32) -> ()
    ...
    %core_0_3 = aie.core(%tile_0_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          ...
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %4 = aie.objectfifo.acquire @of_sincosD(Produce, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %c1024_i32 = arith.constant 1024 : i32
          func.call @vector_scale(%3, %5, %1, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1xf32>, i32) -> ()
    ...
    %core_2_5 = aie.core(%tile_2_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          %0 = aie.objectfifo.acquire @of_sincosD(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %2 = aie.objectfifo.acquire @of_multEc(Produce, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %c1024_i32 = arith.constant 1024 : i32
    ...
    %core_2_4 = aie.core(%tile_2_4) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          %0 = aie.objectfifo.acquire @of_sincosD(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %2 = aie.objectfifo.acquire @of_multEr(Produce, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %c1024_i32 = arith.constant 1024 : i32
    ...
    %core_3_5 = aie.core(%tile_3_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          %0 = aie.objectfifo.acquire @of_multEc(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %2 = aie.objectfifo.acquire @visC(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %4 = aie.objectfifo.acquire @of_subFc(Produce, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %c1024_i32 = arith.constant 1024 : i32
          func.call @vector_mult(%1, %3, %5, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1024xf32>, i32) -> ()
    ...
    %core_3_4 = aie.core(%tile_3_4) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          %0 = aie.objectfifo.acquire @of_multEr(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %2 = aie.objectfifo.acquire @visR(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %4 = aie.objectfifo.acquire @of_subFr(Produce, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %c1024_i32 = arith.constant 1024 : i32
          func.call @vector_mult(%1, %3, %5, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1024xf32>, i32) -> ()
    ...
    %core_3_3 = aie.core(%tile_3_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c9 step %c1_1 {
          %0 = aie.objectfifo.acquire @of_subFr(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %2 = aie.objectfifo.acquire @of_subFc(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %4 = aie.objectfifo.acquire @of_mean(Produce, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %c1024_i32 = arith.constant 1024 : i32
          func.call @vector_sub(%1, %3, %5, %c1024_i32) : (memref<1024xf32>, memref<1024xf32>, memref<1024xf32>, i32) -> ()
    ...
    %core_3_2 = aie.core(%tile_3_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1xf32>> -> memref<1xf32>
        %2 = aie.objectfifo.acquire @of_mean(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
        %c0_i32 = arith.constant 0 : i32
        %c0_i32_0 = arith.constant 0 : i32
        func.call @mean(%3, %1, %c0_i32, %c0_i32_0) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
        %c1024_i32 = arith.constant 1024 : i32
        %c1_i32 = arith.constant 1 : i32
        func.call @mean(%3, %1, %c1024_i32, %c1_i32) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
        aie.objectfifo.release @of_mean(Consume, 1)
        %c2 = arith.constant 2 : index
        %c9 = arith.constant 9 : index
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c2 to %c9 step %c1_1 {
          %6 = aie.objectfifo.acquire @of_mean(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
          %7 = aie.objectfifo.subview.access %6[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
          %c1024_i32_4 = arith.constant 1024 : i32
          %c1_i32_5 = arith.constant 1 : i32
          func.call @mean(%7, %1, %c1024_i32_4, %c1_i32_5) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
          aie.objectfifo.release @of_mean(Consume, 1)
        }
        %4 = aie.objectfifo.acquire @of_mean(Consume, 1) : !aie.objectfifosubview<memref<1024xf32>>
        %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<1024xf32>> -> memref<1024xf32>
        %c1024_i32_2 = arith.constant 1024 : i32
        %c1_i32_3 = arith.constant 1 : i32
        func.call @mean(%5, %1, %c1024_i32_2, %c1_i32_3) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
        %c9216_i32 = arith.constant 9216 : i32
        %c2_i32 = arith.constant 2 : i32
        func.call @mean(%5, %1, %c9216_i32, %c2_i32) : (memref<1024xf32>, memref<1xf32>, i32, i32) -> ()
        aie.objectfifo.release @of_mean(Consume, 1)
